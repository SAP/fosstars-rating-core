...
1.  **Number of projects on GitHub that use an open source project:** 58
1.  **Number of stars for a GitHub repository:** 15309
1.  **Number of watchers for a GitHub repository:** 375
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, CPP, JAVA, C_SHARP, F_SHARP, RUBY, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
...
1.  **Does it use nohttp?** No
1.  **Package managers:** GRADLE, NPM, YARN, RUBYGEMS, GOMODULES
