...
1.  **[Security testing](#security-testing)**: **3.91** (weight is 1.0)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/sentencepiece)
...
Score: **3.91**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Number of projects on GitHub that use an open source project:** 10156
1.  **Number of stars for a GitHub repository:** 5409
...
1.  **Is it included to OSS-Fuzz?** Yes
1.  **Programming languages:** CPP, PYTHON, OTHER
