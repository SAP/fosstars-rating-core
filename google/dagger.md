...
1.  **[Security testing](#security-testing)**: **2.73** (weight is 1.0)
...
Score: **2.73**, confidence is 9.52 (high), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **16147**
1.  Number of watchers for a GitHub repository: **570**
...
1.  [CVE-2008-6636](https://nvd.nist.gov/vuln/detail/CVE-2008-6636): Optional[PHP remote file inclusion vulnerability in skins/default.php in Geody Labs Dagger - The Cutting Edge r12feb2008, when register_globals is enabled, allows remote attackers to execute arbitrary PHP code via a URL in the dir_edge_skins parameter.  NOTE: the provenance of this information is unknown; the details are obtained solely from third party information.]
