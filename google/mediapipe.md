...
1.  **[Security testing](#security-testing)**: **0.19** (weight is 1.0)
...
Score: **0.19**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Number of projects on GitHub that use an open source project:** 1311
1.  **Number of stars for a GitHub repository:** 14037
1.  **Number of watchers for a GitHub repository:** 454
