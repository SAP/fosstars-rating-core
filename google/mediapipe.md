...
575 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 575
...
1.  **Number of projects on GitHub that use an open source project:** 6893
1.  **Number of stars for a GitHub repository:** 20530
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, CPP, JAVA, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER
