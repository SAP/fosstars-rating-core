...
1.  **[Security testing](#security-testing)**: **3.45** (weight is 1.0)
...
Score: **3.45**, confidence is 10.0 (max), weight is 1.0 (high)
...
838 commits in the last 3 months results to 10.00 points
48 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 838
1.  **Number of contributors in the last three months:** 48
...
1.  **Number of projects on GitHub that use an open source project:** 2280
1.  **Number of stars for a GitHub repository:** 14322
1.  **Number of watchers for a GitHub repository:** 249
