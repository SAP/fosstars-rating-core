...
1.  **[Security testing](#security-testing)**: **2.63** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **1.05** (weight is 1.0)
...
Score: **2.63**, confidence is 10.0 (max), weight is 1.0 (high)
...
1033 commits in the last 3 months results to 10.00 points
40 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 1033
1.  **Number of contributors in the last three months:** 40
...
1.  **Number of projects on GitHub that use an open source project:** 7809
1.  **Number of stars for a GitHub repository:** 21914
...
Score: **1.05**, confidence is 10.0 (max), weight is 1.0 (high)
