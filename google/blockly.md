...
151 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 151
...
1.  **Number of projects on GitHub that use an open source project:** 1597
1.  **Number of stars for a GitHub repository:** 11004
1.  **Number of watchers for a GitHub repository:** 463
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** PHP, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER
