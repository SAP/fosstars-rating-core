...
8 contributors increase the score value from 8.31 to 9.97
...
1.  **Number of projects on GitHub that use an open source project:** 310
1.  **Number of stars for a GitHub repository:** 12576
1.  **Number of watchers for a GitHub repository:** 396
