...
**Score**: **4.08**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **2.22** (weight is 0.5)
...
5 contributors increase the score value from 1.85 to 2.22
...
1.  **Number of projects on GitHub that use an open source project:** 1058
1.  **Number of stars for a GitHub repository:** 14616
...
1.  [CVE-2022-21128](https://nvd.nist.gov/vuln/detail/CVE-2022-21128): Insufficient control flow management in the Intel(R) Advisor software before version 7.6.0.37 may allow an authenticated user to potentially enable escalation of privilege via local access.
