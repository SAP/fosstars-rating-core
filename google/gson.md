...
1.  **[Security testing](#security-testing)**: **5.82** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **9.42** (weight is 0.5)
...
Score: **5.82**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **9.42**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

51 commits in the last 3 months results to 7.85 points
5 contributors increase the score value from 7.85 to 9.42
...
1.  **Number of projects on GitHub that use an open source project:** 312857
1.  **Number of stars for a GitHub repository:** 20083
