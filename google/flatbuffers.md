...
1.  **Number of projects on GitHub that use an open source project:** 47417
1.  **Number of stars for a GitHub repository:** 19920
...
1.  **Does it use nohttp?** No
1.  **Package managers:** MAVEN, GRADLE, NPM, YARN, DOTNET, COMPOSER, GOMODULES
