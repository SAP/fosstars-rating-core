...
1.  **[Project activity](#project-activity)**: **9.69** (weight is 0.5)
...
Score: **9.69**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

60 commits in the last 3 months results to 9.23 points
...
1.  **Number of commits in the last three months:** 60
...
1.  **Number of projects on GitHub that use an open source project:** 1027
1.  **Number of stars for a GitHub repository:** 16928
1.  **Number of watchers for a GitHub repository:** 643
...
1.  [CVE-2020-35864](https://nvd.nist.gov/vuln/detail/CVE-2020-35864): An issue was discovered in the flatbuffers crate through 2020-04-11 for Rust. read_scalar (and read_scalar_at) can transmute values without unsafe blocks.
