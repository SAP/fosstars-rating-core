...
1.  **[Security testing](#security-testing)**: **5.43** (weight is 1.0)
...
Score: **5.43**, confidence is 10.0 (max), weight is 1.0 (high)
...
68 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 68
...
1.  **Number of projects on GitHub that use an open source project:** 990
1.  **Number of stars for a GitHub repository:** 16849
