...
1.  **[Security testing](#security-testing)**: **4.02** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **3.85** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.44** (weight is 0.5)
...
Score: **4.02**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **2.44**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2199
...
Score: **3.85**, confidence is 10.0 (max), weight is 1.0 (high)
