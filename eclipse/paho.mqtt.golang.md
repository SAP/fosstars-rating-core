...
**Score**: **4.03**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **1.96** (weight is 0.5)
...
Score: **2.08**, confidence is 9.52 (high), weight is 1.0 (high)
...
Score: **1.96**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1742
...
Score: **2.5**, confidence is 8.0 (low), weight is 1.0 (high)
