...
1.  **[Project popularity](#project-popularity)**: **1.72** (weight is 0.5)
...
4 contributors increase the score value from 1.69 to 1.86
...
Score: **1.72**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1450
