...
public class OssSecurityRatingVerificationTest {
  ...
  /**
   * This class implements a verification procedure for {@link OssSecurityRating}. The class loads
   * test vectors, and provides methods to verify a {@link OssSecurityRating} against those test
   * vectors.
   */
  private static class OssSecurityRatingVerification extends RatingVerification {
    ...
    /**
     * Creates an instance of {@link OssSecurityRatingVerification} for a specified rating. The
     * method loads test vectors from a default resource.
     *
