...
public class ArtifactReleaseHistoryScoreTest {
  ...
  public void testCalculateVersionStatistics() {
    ...
    versionInfos.add(new VersionInfo(90, new ArtifactVersion("3.0.0", now)));
    versionInfos.add(new VersionInfo(180, new ArtifactVersion("2.0.0", now.minusDays(90))));
    versionInfos.add(new VersionInfo(250, new ArtifactVersion("1.5.0", now.minusDays(180))));
    versionInfos.add(new VersionInfo(-1, new ArtifactVersion("1.0.0", now.minusDays(250))));
  ...
  public void testCalculateVersionStatisticsFromArtifactVersions() {
    ...
    Collection<VersionInfo> versionInfo = ArtifactReleaseHistoryScore.versionInfo(artifactVersions);
  ...
  public void testCurrentReleasedVersionBestHistory() {
    ArtifactVersion version100 = new ArtifactVersion("1.0.0", LocalDateTime.now().minusDays(60));
    ArtifactVersion version110 = new ArtifactVersion("1.1.0", LocalDateTime.now().minusDays(20));
    ArtifactVersion version120 = new ArtifactVersion("1.2.0", LocalDateTime.now().minusDays(7));
  ...
  public void testCurrentReleasedVersionGoodHistory() {
    ArtifactVersion version100 = new ArtifactVersion("1.0.0", LocalDateTime.now().minusDays(150));
    ArtifactVersion version110 = new ArtifactVersion("1.1.0", LocalDateTime.now().minusDays(50));
    ArtifactVersion version120 = new ArtifactVersion("1.2.0", LocalDateTime.now().minusDays(7));
  ...
  public void testCurrentReleasedVersionBadHistory() {
    ArtifactVersion version100 = new ArtifactVersion("1.0.0", LocalDateTime.now().minusDays(420));
    ArtifactVersion version110 = new ArtifactVersion("1.1.0", LocalDateTime.now().minusDays(50));
    ArtifactVersion version120 = new ArtifactVersion("1.2.0", LocalDateTime.now().minusDays(7));
  ...
  public void testTwoMonthOldVersionStable() {
    ...
    Value<ArtifactVersions> versions =
        RELEASED_ARTIFACT_VERSIONS.value(
            ArtifactVersions.of(
                version100, version110, version120, version130, version140, version150));
  ...
  public void testTwoMonthOldGoodVersionTrend() {
    ArtifactVersion version100 = new ArtifactVersion("1.0.0", LocalDateTime.now().minusDays(1000));
    ArtifactVersion version110 = new ArtifactVersion("1.1.0", LocalDateTime.now().minusDays(780));
    ArtifactVersion version120 = new ArtifactVersion("1.2.0", LocalDateTime.now().minusDays(450));
    ArtifactVersion version130 = new ArtifactVersion("1.3.0", LocalDateTime.now().minusDays(300));
    ArtifactVersion version140 = new ArtifactVersion("1.4.0", LocalDateTime.now().minusDays(150));
    ArtifactVersion version150 = new ArtifactVersion("1.5.0", LocalDateTime.now().minusDays(60));
  ...
  public void testTwoMonthOldVersionBadVersionTrend() {
    LocalDateTime now = LocalDateTime.now();
    ArtifactVersion version100 = new ArtifactVersion("1.0.0", now.minusDays(18 * 31));
    ArtifactVersion version110 = new ArtifactVersion("1.1.0", now.minusDays(17 * 31));
    ArtifactVersion version120 = new ArtifactVersion("1.2.0", now.minusDays(15 * 31));
    ArtifactVersion version130 = new ArtifactVersion("1.3.0", now.minusDays(14 * 31));
    ArtifactVersion version140 = new ArtifactVersion("1.4.0", now.minusDays(12 * 31));
  ...
  public void testEightMonthOldVersion() {
    ArtifactVersion version100 = new ArtifactVersion("1.0.0", LocalDateTime.now().minusDays(420));
    ArtifactVersion version110 = new ArtifactVersion("1.1.0", LocalDateTime.now().minusDays(240));
  ...
  public void testWithNoInfo() {
    assertThrows(
        IllegalArgumentException.class, () -> new ArtifactReleaseHistoryScore().calculate());
  }
