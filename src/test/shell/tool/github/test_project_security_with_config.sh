...
declare -a expected_strings=(
  ...
  'Storing info about projects to .fosstars/report/github_projects.json'
  'Storing a report to .fosstars/report/README.md'
  'Storing the cache to .fosstars/project_rating_cache.json'
)
