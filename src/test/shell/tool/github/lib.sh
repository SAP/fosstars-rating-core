...
declare -a project_security_default_expected_strings=(
  ...
  'If a project runs Mypy scan checks for commits'
  'If a project runs Mypy scans'
  'If a project runs Pylint scan checks for commits'
  'If a project runs Pylint scans'
