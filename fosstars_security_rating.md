...
1.  **[Security testing](#security-testing)**: 5.6, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 0.05, confidence is 10.0 (max), importance is 0.5 (medium)
...
104 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

The sub-score uses 2 features:

1.  Number of commits in the last three months: 104
1.  Number of contributors in the last three months: 2

### Project popularity

Score: 0.05, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 21
