...
1.  **[Security testing](#security-testing)**: **2.98** (weight is 1.0)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/pypa/setuptools)
...
Score: **2.98**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Number of projects on GitHub that use an open source project:** 106410
1.  **Number of stars for a GitHub repository:** 1455
1.  **Number of watchers for a GitHub repository:** 84
