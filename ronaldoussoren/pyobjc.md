...
**Score**: **2.43**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **0.46** (weight is 0.5)
...
1.  [Suggest a security policy for the project](https://github.com/ronaldoussoren/pyobjc/security/policy)
...
1.  **Number of projects on GitHub that use an open source project:** 340
1.  **Number of stars for a GitHub repository:** 199
