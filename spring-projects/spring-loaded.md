...
**Score**: **3.3**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **0.36** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **3.26** (weight is 0.5)
...
Score: **0.36**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **3.26**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2576**
