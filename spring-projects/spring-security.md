...
1.  **[Project popularity](#project-popularity)**: **7.72** (weight is 0.5)
...
1.  **Info about vulnerabilities in the project:** 13 vulnerabilities, [details below](#known-vulnerabilities)
...
Score: **7.72**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 6252
1.  **Number of watchers for a GitHub repository:** 441
