...
1.  **[Security testing](#security-testing)**: **1.64** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **7.78** (weight is 0.5)
...
Score: **1.64**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **7.78**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 438
1.  **Number of stars for a GitHub repository:** 1210
