...
1.  **[Project popularity](#project-popularity)**: **1.58** (weight is 0.5)
...
4 contributors increase the score value from 9.54 to 10.49
...
Score: **1.58**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1185
