...
1.  **[Project popularity](#project-popularity)**: **6.47** (weight is 0.5)
...
Score: **6.47**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1000
1.  **Number of stars for a GitHub repository:** 4467
