...
1.  **[Project popularity](#project-popularity)**: **4.94** (weight is 0.5)
...
Score: **4.94**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 4150
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** JAVA, RUBY, OTHER
