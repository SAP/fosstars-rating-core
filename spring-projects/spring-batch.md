...
1.  **[Project popularity](#project-popularity)**: **8.2** (weight is 0.5)
...
Score: **8.2**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 7634
1.  **Number of stars for a GitHub repository:** 2298
