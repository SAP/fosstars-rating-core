...
1.  **[Project activity](#project-activity)**: **5.75** (weight is 0.5)
    
1.  **[Project popularity](#project-popularity)**: **8.84** (weight is 0.5)
...
Score: **5.75**, confidence is 10.0 (max), weight is 0.5 (medium)
...
Score: **8.84**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 7821
1.  **Number of stars for a GitHub repository:** 2745
