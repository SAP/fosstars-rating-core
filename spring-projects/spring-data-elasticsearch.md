...
**Score**: **5.99**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **9.6** (weight is 0.5)
    
1.  **[Project popularity](#project-popularity)**: **7.7** (weight is 0.5)
...
Score: **9.6**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

52 commits in the last 3 months results to 8.00 points
5 contributors increase the score value from 8.00 to 9.60

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 52
1.  **Number of contributors in the last three months:** 5


### Project popularity

Score: **7.7**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 6409
1.  **Number of stars for a GitHub repository:** 2529
