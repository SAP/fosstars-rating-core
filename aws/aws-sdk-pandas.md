...
1.  **[Project popularity](#project-popularity)**: **4.07** (weight is 0.5)
...
Score: **6.7**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **4.07**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 817
1.  **Number of stars for a GitHub repository:** 3330
1.  **Number of watchers for a GitHub repository:** 59
...
Score: **4.74**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **If a project runs Bandit scan checks for commits:** Yes
1.  **If a project runs Bandit scans:** Yes
1.  **Programming languages:** PYTHON, OTHER
