...
**Score**: **3.63**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.73** (weight is 0.5)
...
496 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 496
1.  **Number of contributors in the last three months:** 10


### Project popularity

Score: **3.73**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1771
1.  **Number of stars for a GitHub repository:** 1882
