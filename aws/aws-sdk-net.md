...
1.  **[Project popularity](#project-popularity)**: **3.43** (weight is 0.5)
...
405 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 405
1.  **Number of contributors in the last three months:** 8


### Project popularity

Score: **3.43**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1509
1.  **Number of stars for a GitHub repository:** 1691
1.  **Number of watchers for a GitHub repository:** 219
