...
1.  **[Project popularity](#project-popularity)**: **3.17** (weight is 0.5)
...
Score: **8.33**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **3.17**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 2048
1.  **Number of stars for a GitHub repository:** 1539
