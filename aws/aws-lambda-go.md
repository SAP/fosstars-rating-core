...
1.  **[Security testing](#security-testing)**: **5.77** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **3.42** (weight is 0.5)
...
Score: **5.77**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **3.42**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 3216
