...
1.  **[Project popularity](#project-popularity)**: **1.53** (weight is 0.5)
...
628 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 628
1.  **Number of contributors in the last three months:** 7


### Project popularity

Score: **1.53**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1239
