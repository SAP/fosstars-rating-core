...
1.  **[Security testing](#security-testing)**: **4.76** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **0.47** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **3.59** (weight is 0.5)
...
Score: **3.59**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1872
1.  **Number of stars for a GitHub repository:** 2221
1.  **Number of watchers for a GitHub repository:** 36
...
Score: **0.47**, confidence is 10.0 (max), weight is 1.0 (high)
