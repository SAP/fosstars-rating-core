...
1.  **[Project popularity](#project-popularity)**: **3.6** (weight is 0.5)
...
Score: **3.6**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1875
1.  **Number of stars for a GitHub repository:** 2222
