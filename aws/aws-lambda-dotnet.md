...
**Score**: **3.99**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **4.43** (weight is 0.5)
    
1.  **[Project popularity](#project-popularity)**: **1.39** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-lambda-dotnet)
...
Score: **4.43**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

24 commits in the last 3 months results to 3.69 points
5 contributors increase the score value from 3.69 to 4.43
...
Score: **1.39**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 5
1.  **Number of stars for a GitHub repository:** 1020
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C_SHARP, F_SHARP, JAVASCRIPT, OTHER
