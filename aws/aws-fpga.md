...
**Score**: **3.18**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **1.09** (weight is 1.0)
...
Score: **1.09**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **2.06**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1151
