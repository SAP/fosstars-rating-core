...
1.  **[Project popularity](#project-popularity)**: **7.28** (weight is 0.5)
...
Score: **7.28**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 4815
1.  **Number of watchers for a GitHub repository:** 738
