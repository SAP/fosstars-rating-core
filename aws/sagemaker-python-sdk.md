...
1.  **[Security testing](#security-testing)**: **5.21** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **1.47** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **3.71** (weight is 0.5)
...
Score: **5.21**, confidence is 10.0 (max), weight is 1.0 (high)
...
145 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 145
1.  **Number of contributors in the last three months:** 4


### Project popularity

Score: **3.71**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 2237
1.  **Number of stars for a GitHub repository:** 1776
1.  **Number of watchers for a GitHub repository:** 134
...
Score: **1.47**, confidence is 10.0 (max), weight is 1.0 (high)
