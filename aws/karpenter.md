...
1.  **[Security testing](#security-testing)**: **5.58** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **2.27** (weight is 1.0)
...
Score: **5.58**, confidence is 10.0 (max), weight is 1.0 (high)
...
282 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 282
1.  **Number of contributors in the last three months:** 1


### Project popularity

Score: **4.13**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 10
1.  **Number of stars for a GitHub repository:** 3930
