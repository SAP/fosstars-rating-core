...
1.  **[Project activity](#project-activity)**: **6.28** (weight is 0.5)
...
Score: **2.38**, confidence is 9.52 (high), weight is 1.0 (high)
...
Score: **6.28**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

34 commits in the last 3 months results to 5.23 points
13 contributors increase the score value from 5.23 to 6.28
...
Score: **2.44**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1844
1.  **Number of watchers for a GitHub repository:** 177
