...
1.  **[Project popularity](#project-popularity)**: **2.49** (weight is 0.5)
...
10 contributors increase the score value from 7.85 to 9.42
...
Score: **2.49**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1947
