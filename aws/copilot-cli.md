...
1.  **[Project popularity](#project-popularity)**: **2.81** (weight is 0.5)
...
175 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 175
1.  **Number of contributors in the last three months:** 1


### Project popularity

Score: **2.81**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2637
1.  **Number of watchers for a GitHub repository:** 51
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
