...
1.  **[Project popularity](#project-popularity)**: **1.14** (weight is 0.5)
...
Score: **1.14**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1004
1.  **Number of watchers for a GitHub repository:** 42
