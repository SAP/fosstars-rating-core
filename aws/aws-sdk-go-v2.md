...
1.  **[Project popularity](#project-popularity)**: **8.97** (weight is 0.5)
...
1.  **Number of projects on GitHub that use an open source project:** 10454
1.  **Number of stars for a GitHub repository:** 1842
1.  **Number of watchers for a GitHub repository:** 47
