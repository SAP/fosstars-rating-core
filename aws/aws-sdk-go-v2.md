...
1.  **[Project popularity](#project-popularity)**: **2.33** (weight is 0.5)
...
4 contributors increase the score value from 9.23 to 10.15
...
Score: **2.33**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1616
1.  **Number of stars for a GitHub repository:** 1099
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** JAVA, GO, OTHER
