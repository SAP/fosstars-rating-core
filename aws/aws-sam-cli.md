...
**Score**: **5.71**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **6.54** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **4.39** (weight is 1.0)
...
Score: **6.54**, confidence is 10.0 (max), weight is 1.0 (high)
...
141 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 141
...
1.  **Number of projects on GitHub that use an open source project:** 1151
1.  **Number of stars for a GitHub repository:** 6219
...
Score: **4.39**, confidence is 10.0 (max), weight is 1.0 (high)
