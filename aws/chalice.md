...
**Score**: **6.27**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **9.94** (weight is 0.5)
...
5 contributors increase the score value from 9.54 to 11.45
...
Score: **9.94**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1165
1.  **Number of stars for a GitHub repository:** 8325
