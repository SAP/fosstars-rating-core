...
1.  **[Project popularity](#project-popularity)**: **8.96** (weight is 0.5)
...
5 contributors increase the score value from 6.92 to 8.31
...
Score: **8.96**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 8116
