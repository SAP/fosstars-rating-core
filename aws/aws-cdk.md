...
1.  **[Project popularity](#project-popularity)**: **7.71** (weight is 0.5)
...
533 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 533
1.  **Number of contributors in the last three months:** 7


### Project popularity

Score: **7.71**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of watchers for a GitHub repository:** 204
