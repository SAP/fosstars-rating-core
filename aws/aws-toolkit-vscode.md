...
1.  **[Project popularity](#project-popularity)**: **1.16** (weight is 0.5)
...
Score: **1.16**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1026
1.  **Number of watchers for a GitHub repository:** 39
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** JAVA, C_SHARP, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
