...
**Score**: **7.3**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **6.54** (weight is 0.5)
...
Score: **6.54**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 5755
