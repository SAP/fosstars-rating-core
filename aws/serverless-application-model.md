...
1.  **[Project popularity](#project-popularity)**: **9.12** (weight is 0.5)
...
Score: **9.12**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 8039
