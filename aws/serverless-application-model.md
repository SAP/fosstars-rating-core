...
**Score**: **5.81**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **4.91** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **5.89** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **9.91** (weight is 0.5)
...
Score: **9.91**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 8918
...
Score: **5.89**, confidence is 10.0 (max), weight is 1.0 (high)
