...
1.  **[Security testing](#security-testing)**: **1.39** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **4.92** (weight is 0.5)
...
Score: **1.39**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **4.92**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 108
1.  **Number of stars for a GitHub repository:** 4252
