...
**Score**: **4.84**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.8** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-sdk-ruby)
...
Score: **3.8**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 3303
