...
1.  **[Project popularity](#project-popularity)**: **3.9** (weight is 0.5)
...
Score: **3.9**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 7
1.  **Number of stars for a GitHub repository:** 3430
1.  **Number of watchers for a GitHub repository:** 139
