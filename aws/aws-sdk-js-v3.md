...
1.  **[Project popularity](#project-popularity)**: **6.66** (weight is 0.5)
...
Score: **6.66**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 8138
1.  **Number of stars for a GitHub repository:** 1129
1.  **Number of watchers for a GitHub repository:** 31
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** JAVA, RUBY, JAVASCRIPT, TYPESCRIPT, OTHER
