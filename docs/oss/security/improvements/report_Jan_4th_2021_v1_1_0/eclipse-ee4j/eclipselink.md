...
**Score**: 4.53, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.4, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[LGTM score](#lgtm-score)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 0.14, confidence is 10.0 (max), importance is 0.5 (medium)
...
4 contributors increase the score value from 7.08 to 7.78
...
Score: 0.14, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 88
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/eclipse-ee4j/eclipselink)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse-ee4j/eclipselink/security/policy)
