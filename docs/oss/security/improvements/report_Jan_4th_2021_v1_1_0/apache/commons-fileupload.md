...
**Score**: 3.73, where max score value is 10.0
...
1.  **[Unpatched vulnerabilities](#unpatched-vulnerabilities)**: 0.0, confidence is 10.0 (max), importance is 0.8 (high)
...
1.  **[Project activity](#project-activity)**: 5.75, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 0.28, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.0, confidence is 10.0 (max), importance is 0.8 (high)



Found 2 unpatched vulnerabilities with high severity which decreased the score on 16.00 (2 * 8.00)

The sub-score uses 1 feature:

1.  Info about vulnerabilities: 5 vulnerabilities
...
Score: 5.75, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

34 commits in the last 3 months results to 5.23 points
3 contributors increase the score value from 5.23 to 5.75
...
Score: 0.28, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 135
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/commons-fileupload)
