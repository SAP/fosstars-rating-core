...
1.  **[Security testing](#security-testing)**: 5.92, confidence is 10.0 (max), importance is 1.0 (high)
...
2.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/cxf)
3.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/cxf/security/policy)
