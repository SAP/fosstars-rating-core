...
**Score**: 4.35, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 1.44, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 7.78, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 0.32, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.44, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 7.78, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

46 commits in the last 3 months results to 7.08 points
3 contributors increase the score value from 7.08 to 7.78
...
Score: 0.32, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 221
1.  Number of watchers for a GitHub repository: 30
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/httpcomponents-core)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/httpcomponents-core/security/policy)
