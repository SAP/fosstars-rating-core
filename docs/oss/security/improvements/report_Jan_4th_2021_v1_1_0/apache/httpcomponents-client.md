...
**Score**: 3.64, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 5.44, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 7.6, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Unpatched vulnerabilities](#unpatched-vulnerabilities)**: 2.0, confidence is 10.0 (max), importance is 0.8 (high)
...
1.  **[Project activity](#project-activity)**: 4.74, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.36, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 4.74, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

28 commits in the last 3 months results to 4.31 points
4 contributors increase the score value from 4.31 to 4.74
...
Score: 7.6, confidence is 10.0 (max), importance is 1.0 (high)
...
3.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/httpcomponents-client/security/policy)
