...
**Score**: 5.99, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 5.12, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 1.06, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 5.12, confidence is 10.0 (max), importance is 1.0 (high)
...
140 commits in the last 3 months results to 10.00 points
3 contributors increase the score value from 10.00 to 11.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 140
1.  Number of contributors in the last three months: 3

### Project popularity

Score: 1.06, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 756
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/commons-io)
