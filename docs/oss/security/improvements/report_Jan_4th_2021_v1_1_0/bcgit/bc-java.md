...
**Score**: 3.37, where max score value is 10.0
...
198 commits in the last 3 months results to 10.00 points
7 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 198
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/bcgit/bc-java/security/policy)
