...
**Score**: 6.21, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 4.22, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 4.22, confidence is 10.0 (max), importance is 1.0 (high)
