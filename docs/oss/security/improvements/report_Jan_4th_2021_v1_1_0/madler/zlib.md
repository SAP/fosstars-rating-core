...
**Score**: 3.12, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 3.27, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.27, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  A set of programming languages: C, CPP, C_SHARP, OTHER
1.  Is it included to OSS-Fuzz? Yes
