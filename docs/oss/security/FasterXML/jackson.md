...
**Score**: 2.81, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 7.34, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 7.34, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6193
1.  Number of watchers for a GitHub repository: 344
...
1.  A set of programming languages: 
1.  Is it included to OSS-Fuzz? No
