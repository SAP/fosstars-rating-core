...
**Score**: 4.22, where max score value is 10.0
...
1.  **[Security awareness](#security-awareness)**: 2.0, confidence is 10.0 (max), importance is 0.9 (high)
...
1.  **[Project popularity](#project-popularity)**: 3.28, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.0, confidence is 10.0 (max), importance is 0.9 (high)
...
1.  Info about vulnerabilities: 53 vulnerabilities
...
364 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

The sub-score uses 2 features:

1.  Number of commits in the last three months: 364
1.  Number of contributors in the last three months: 2

### Project popularity

Score: 3.28, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2730
