...
1.  **[Project popularity](#project-popularity)**: **3.34** (weight is 0.5)
...
Score: **3.34**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2821**
