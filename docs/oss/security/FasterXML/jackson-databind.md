...
290 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **290**
1.  Number of contributors in the last three months: **2**

### Project popularity

Score: **3.31**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2760**
