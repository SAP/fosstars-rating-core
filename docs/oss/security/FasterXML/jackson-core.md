...
1.  **[Project activity](#project-activity)**: **5.82** (weight is 0.5)
...
Score: **5.82**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

36 commits in the last 3 months results to 5.54 points
2 contributors increase the score value from 5.54 to 5.82
...
1.  Number of stars for a GitHub repository: **1961**
1.  Number of watchers for a GitHub repository: **152**
