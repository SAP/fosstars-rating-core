...
1.  **[Project popularity](#project-popularity)**: 2.41, confidence is 10.0 (max), importance is 0.5 (medium)
...
91 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

The sub-score uses 2 features:

1.  Number of commits in the last three months: 91
1.  Number of contributors in the last three months: 2

### Project popularity

Score: 2.41, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1901
1.  Number of watchers for a GitHub repository: 153
