...
1.  Number of stars for a GitHub repository: 10234
1.  Number of watchers for a GitHub repository: 408
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/grumpy/security/policy)
