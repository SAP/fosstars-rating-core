...
1.  Number of stars for a GitHub repository: 18514
1.  Number of watchers for a GitHub repository: 999
...
1.  A set of programming languages: JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/web-starter-kit/security/policy)
