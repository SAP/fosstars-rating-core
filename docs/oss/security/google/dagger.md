...
**Score**: 4.76, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 9.31, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 9.31, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

55 commits in the last 3 months results to 8.46 points
3 contributors increase the score value from 8.46 to 9.31
...
1.  Number of stars for a GitHub repository: 15727
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/dagger/security/policy)
