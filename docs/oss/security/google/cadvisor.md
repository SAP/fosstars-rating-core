...
**Score**: 4.92, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 0.4, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 0.4, confidence is 10.0 (max), importance is 1.0 (high)
...
74 commits in the last 3 months results to 10.00 points
12 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 74
...
1.  Number of stars for a GitHub repository: 11587
1.  Number of watchers for a GitHub repository: 397
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/cadvisor/security/policy)
