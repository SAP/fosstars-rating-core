...
1.  **[Security testing](#security-testing)**: **0.4** (weight is 1.0)
...
Score: **0.4**, confidence is 10.0 (max), weight is 1.0 (high)
...
12 contributors increase the score value from 6.92 to 8.31
...
1.  Number of stars for a GitHub repository: **11741**
