...
1.  **[Security testing](#security-testing)**: **3.22** (weight is 1.0)
...
Score: **3.22**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **22978**
1.  Number of watchers for a GitHub repository: **1315**
