...
**Score**: 6.09, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 3.33, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 3.33, confidence is 10.0 (max), importance is 1.0 (high)
...
515 commits in the last 3 months results to 10.00 points
14 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 515
...
1.  Number of stars for a GitHub repository: 10797
...
1.  A set of programming languages: C, CPP, RUBY, PYTHON, JAVASCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
