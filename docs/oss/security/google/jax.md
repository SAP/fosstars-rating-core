...
**Score**: 5.04, where max score value is 10.0
...
1034 commits in the last 3 months results to 10.00 points
39 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 1034
1.  Number of contributors in the last three months: 39
...
1.  Number of stars for a GitHub repository: 10926
...
1.  A set of programming languages: CPP, PYTHON, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/jax/security/policy)
