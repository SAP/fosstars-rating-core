...
**Score**: 5.65, where max score value is 10.0
...
1.  Number of stars for a GitHub repository: 16992
1.  Number of watchers for a GitHub repository: 875
...
1.  A set of programming languages: CPP, JAVA, OTHER
1.  Is it included to OSS-Fuzz? Yes
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/ExoPlayer)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/ExoPlayer/security/policy)
