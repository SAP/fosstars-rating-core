...
**Score**: 6.36, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 5.07, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Security awareness](#security-awareness)**: 2.5, confidence is 10.0 (max), importance is 0.9 (high)
...
Score: 5.07, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 2.5, confidence is 10.0 (max), importance is 0.9 (high)
...
87 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

The sub-score uses 2 features:

1.  Number of commits in the last three months: 87
...
1.  Number of stars for a GitHub repository: 15591
1.  Number of watchers for a GitHub repository: 646
...
1.  A set of package managers: MAVEN, NPM, YARN, COMPOSER
1.  Does it use nohttp? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/flatbuffers/security/policy)
