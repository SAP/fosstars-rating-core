...
**Score**: **7.99**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **7.45** (weight is 1.0)
...
Score: **7.45**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **16495**
