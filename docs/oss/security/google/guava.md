...
**Score**: 4.44, where max score value is 10.0
...
1.  Number of stars for a GitHub repository: 39878
1.  Number of watchers for a GitHub repository: 2492
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/guava/security/policy)
