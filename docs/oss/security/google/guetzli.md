...
1.  **[Security testing](#security-testing)**: 3.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Number of stars for a GitHub repository: 12490
1.  Number of watchers for a GitHub repository: 500
...
1.  A set of programming languages: CPP, PHP, PYTHON, OTHER
1.  Is it included to OSS-Fuzz? Yes
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/guetzli/security/policy)
