...
1.  **[Project activity](#project-activity)**: 1.69, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.69, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 18470
1.  Number of watchers for a GitHub repository: 382
...
1.  A set of programming languages: PYTHON
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/google/python-fire/security/policy)
