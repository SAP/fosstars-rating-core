...
**Score**: 4.94, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.4, confidence is 10.0 (max), importance is 1.0 (high)
    1.  **[Dependency testing](#dependency-testing)**: 10.0, confidence is 10.0 (max), importance is 1.0 (high)
        ...
        1.  **[OWASP Dependency Check score](#owasp-dependency-check-score)**: 10.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Number of stars for a GitHub repository: 8967
1.  Number of watchers for a GitHub repository: 667
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/zookeeper/security/policy)
