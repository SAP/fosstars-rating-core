...
**Score**: 5.37, where max score value is 10.0
...
1.  Number of stars for a GitHub repository: 17711
1.  Number of watchers for a GitHub repository: 1068
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/kafka/security/policy)
