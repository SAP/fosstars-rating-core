...
1.  **[Project popularity](#project-popularity)**: **1.43** (weight is 0.5)
...
173 commits in the last 3 months results to 10.00 points
9 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **173**
1.  Number of contributors in the last three months: **9**

### Project popularity

Score: **1.43**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1133**
