...
1.  **[Project popularity](#project-popularity)**: **1.74** (weight is 0.5)
...
252 commits in the last 3 months results to 10.00 points
4 contributors increase the score value from 10.00 to 11.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **252**
1.  Number of contributors in the last three months: **4**

### Project popularity

Score: **1.74**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1464**
