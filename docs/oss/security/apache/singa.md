...
1.  **[Security testing](#security-testing)**: **2.76** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **6.46** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **2.72** (weight is 0.5)
...
Score: **2.76**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **6.46**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

35 commits in the last 3 months results to 5.38 points
5 contributors increase the score value from 5.38 to 6.46
...
Score: **2.72**, confidence is 10.0 (max), weight is 0.5 (medium)
