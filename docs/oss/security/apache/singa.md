...
**Score**: 4.74, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 1.24, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 5.6, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[LGTM score](#lgtm-score)**: 7.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[How a project uses CodeQL](#how-a-project-uses-codeql)**: 7.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Security awareness](#security-awareness)**: 6.0, confidence is 10.0 (max), importance is 0.9 (high)
...
1.  **[Project activity](#project-activity)**: 4.23, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 2.57, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.24, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 6.0, confidence is 10.0 (max), importance is 0.9 (high)
...
Score: 4.23, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

25 commits in the last 3 months results to 3.85 points
4 contributors increase the score value from 3.85 to 4.23
...
Score: 2.57, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2158
...
Score: 5.6, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  You can open a pull request to enable CodeQL scans in the project. Make sure that the scans are run on pull requests. More info:
...
2.  You can open a pull request to enable CodeQL scans in the project. More info:
...
3.  You can fix the issues reported by LGTM for the project. More info:
...
5.  You can open a pull request to enable AddressSanitizer for the project. More info:
    1.  [About AdddressSanitizer](https://github.com/google/sanitizers/wiki/AddressSanitizer)
6.  You can open a pull request to enable MemorySanitizer for the project. More info:
    1.  [About AdddressSanitizer](https://github.com/google/sanitizers/wiki/MemorySanitizer)
7.  You can open a pull request to enable UndefinedBehaviorSanitizer for the project. More info:
    1.  [About AdddressSanitizer](https://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html)
8.  You can include the project to OSS-Fuzz. Then, the project is going to be regularly fuzzed. More info:
