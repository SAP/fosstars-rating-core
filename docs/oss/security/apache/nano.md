...
1.  **[Security testing](#security-testing)**: 3.4, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 1.27, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.4, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 1.27, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1129
...
1.  A set of programming languages: JAVASCRIPT
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/nano/security/policy)
