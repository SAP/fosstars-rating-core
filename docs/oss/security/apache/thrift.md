...
1.  **[Project popularity](#project-popularity)**: **9.7** (weight is 0.5)
...
Score: **9.7**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **8097**
1.  Number of watchers for a GitHub repository: **480**
...
1.  A set of package managers: **MAVEN, GRADLE, NPM, YARN, RUBYGEMS, COMPOSER**
1.  Does it use nohttp? **No**
