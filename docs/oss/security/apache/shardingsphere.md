...
**Score**: **6.47**, max score value is 10.0
...
600 commits in the last 3 months results to 10.00 points
3 contributors increase the score value from 10.00 to 11.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **600**
...
1.  Number of stars for a GitHub repository: **13911**
1.  Number of watchers for a GitHub repository: **984**
