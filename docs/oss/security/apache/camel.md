...
1.  **[Project popularity](#project-popularity)**: **4.64** (weight is 0.5)
...
2140 commits in the last 3 months results to 10.00 points
20 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **2140**
1.  Number of contributors in the last three months: **20**

### Project popularity

Score: **4.64**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3731**
