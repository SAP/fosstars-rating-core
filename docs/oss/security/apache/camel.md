...
**Score**: 5.36, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 4.48, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Info about vulnerabilities: 20 vulnerabilities
...
1556 commits in the last 3 months results to 10.00 points
21 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 1556
1.  Number of contributors in the last three months: 21

### Project popularity

Score: 4.48, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 3547
1.  Number of watchers for a GitHub repository: 279
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/camel/security/policy)
