...
1.  Info about vulnerabilities: 19 vulnerabilities
...
1.  Number of stars for a GitHub repository: 28454
1.  Number of watchers for a GitHub repository: 2135
...
1.  A set of programming languages: C, JAVA, SCALA, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/spark/security/policy)
