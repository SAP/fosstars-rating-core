...
**Score**: 3.76, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.11, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 2.59, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.11, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  A set of programming languages: C, RUBY, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/cordova-ios/security/policy)
