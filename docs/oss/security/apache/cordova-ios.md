...
1.  **[Security testing](#security-testing)**: **2.26** (weight is 1.0)
...
Score: **2.26**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **1998**
1.  Number of watchers for a GitHub repository: **192**
