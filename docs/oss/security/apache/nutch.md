...
1.  **[Project popularity](#project-popularity)**: **2.98** (weight is 0.5)
...
4 contributors increase the score value from 4.00 to 4.40
...
Score: **2.98**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2172**
