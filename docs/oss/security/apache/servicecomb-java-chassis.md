...
1.  **[Project popularity](#project-popularity)**: **2.11** (weight is 0.5)
...
3 contributors increase the score value from 7.85 to 8.63
...
Score: **2.11**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1692**
