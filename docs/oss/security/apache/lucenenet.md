...
**Score**: 3.72, where max score value is 10.0
...
1.  A set of programming languages: C_SHARP, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/lucenenet/security/policy)
