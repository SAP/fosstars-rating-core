...
1.  **[Project popularity](#project-popularity)**: **4.86** (weight is 0.5)
...
Score: **4.86**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3896**
