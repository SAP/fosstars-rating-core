...
**Score**: **6.78**, max score value is 10.0
...
652 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **652**
...
1.  Number of stars for a GitHub repository: **35251**
1.  Number of watchers for a GitHub repository: **1403**
...
1.  A set of programming languages: **PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER**
1.  Is it included to OSS-Fuzz? **No**
...
5.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/superset/security/policy)
