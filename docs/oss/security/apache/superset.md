...
**Score**: **6.91**, max score value is 10.0
...
681 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **681**
...
1.  Number of stars for a GitHub repository: **38573**
1.  Number of watchers for a GitHub repository: **1445**
