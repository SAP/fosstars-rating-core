...
**Score**: 4.04, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 1.98, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.98, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1364
1.  Number of watchers for a GitHub repository: 186
