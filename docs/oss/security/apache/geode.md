...
1.  **[Project popularity](#project-popularity)**: **2.57** (weight is 0.5)
...
Score: **2.57**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  A set of package managers: **GRADLE, RUBYGEMS**
1.  Does it use nohttp? **No**
