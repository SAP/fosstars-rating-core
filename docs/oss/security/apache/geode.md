...
**Score**: **5.23**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.63** (weight is 0.5)
...
Score: **2.63**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1955**
