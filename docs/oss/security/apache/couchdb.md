...
1.  **[Security testing](#security-testing)**: **0.22** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **5.63** (weight is 0.5)
...
Score: **0.22**, confidence is 10.0 (max), weight is 1.0 (high)
...
8 contributors increase the score value from 4.31 to 5.17
...
Score: **5.63**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4820**
