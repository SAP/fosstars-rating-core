...
**Score**: 6.82, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 5.4, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 3.5, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[LGTM score](#lgtm-score)**: 2.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[How a project uses CodeQL](#how-a-project-uses-codeql)**: 5.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Security awareness](#security-awareness)**: 6.5, confidence is 10.0 (max), importance is 0.9 (high)
...
Score: 5.4, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 6.5, confidence is 10.0 (max), importance is 0.9 (high)
...
1.  Info about vulnerabilities: 21 vulnerabilities
...
1191 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

The sub-score uses 2 features:

1.  Number of commits in the last three months: 1191
...
1.  Number of stars for a GitHub repository: 19842
1.  Number of watchers for a GitHub repository: 737
...
Score: 3.5, confidence is 10.0 (max), importance is 1.0 (high)
