...
**Score**: **7.75**, max score value is 10.0
...
610 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **610**
...
1.  Number of stars for a GitHub repository: **22380**
1.  Number of watchers for a GitHub repository: **742**
