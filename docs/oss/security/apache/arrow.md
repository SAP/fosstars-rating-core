...
**Score**: 5.89, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 3.02, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 7.87, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.02, confidence is 10.0 (max), importance is 1.0 (high)
...
608 commits in the last 3 months results to 10.00 points
22 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 608
1.  Number of contributors in the last three months: 22

### Project popularity

Score: 7.87, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6818
...
1.  A set of programming languages: C, CPP, JAVA, C_SHARP, RUBY, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? Yes
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/arrow)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/arrow/security/policy)
