...
**Score**: **6.21**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **4.36** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **8.26** (weight is 0.5)
...
Score: **4.36**, confidence is 10.0 (max), weight is 1.0 (high)
...
644 commits in the last 3 months results to 10.00 points
22 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **644**
1.  Number of contributors in the last three months: **22**

### Project popularity

Score: **8.26**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **7187**
...
1.  A set of package managers: **MAVEN, NPM, YARN, RUBYGEMS**
1.  Does it use nohttp? **No**
