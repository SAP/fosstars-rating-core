...
**Score**: **7.03**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **6.5** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **9.26** (weight is 0.5)
...
Score: **6.5**, confidence is 10.0 (max), weight is 1.0 (high)
...
495 commits in the last 3 months results to 10.00 points
25 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **495**
1.  Number of contributors in the last three months: **25**

### Project popularity

Score: **9.26**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **8147**
