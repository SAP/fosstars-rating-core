...
1.  **[Project popularity](#project-popularity)**: **9.27** (weight is 0.5)
...
491 commits in the last 3 months results to 10.00 points
23 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **491**
1.  Number of contributors in the last three months: **23**

### Project popularity

Score: **9.27**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **8151**
1.  Number of watchers for a GitHub repository: **335**
