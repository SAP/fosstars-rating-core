...
**Score**: 6.39, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 5.22, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 7.12, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 5.22, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Number of commits in the last three months: 664
...
Score: 7.12, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6096
1.  Number of watchers for a GitHub repository: 308
...
1.  A set of programming languages: C, CPP, JAVA, C_SHARP, RUBY, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? Yes
