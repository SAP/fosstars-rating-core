...
**Score**: 4.78, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 1.56, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Vulnerability discovery and security testing](#vulnerability-discovery-and-security-testing)**: 2.0, confidence is 10.0 (max), importance is 0.6 (medium)
    1.  **[Security testing](#security-testing)**: 1.56, confidence is 10.0 (max), importance is 1.0 (high)
        ...
        1.  **[Memory-safety testing](#memory-safety-testing)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[nohttp tool](#nohttp-tool)**: 0.0, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project activity](#project-activity)**: 7.59, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Community commitment](#community-commitment)**: 7.0, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 4.41, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.56, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 7.59, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 4.41, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 3318
1.  Number of watchers for a GitHub repository: 329
...
1.  A set of programming languages: C, CPP, JAVA, PHP, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
