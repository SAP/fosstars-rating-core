...
**Score**: 3.89, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 6.75, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Info about vulnerabilities: 185 vulnerabilities
...
Score: 6.75, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 5105
1.  Number of watchers for a GitHub repository: 493
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/tomcat/security/policy)
