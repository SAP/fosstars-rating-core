...
**Score**: **5.05**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.15** (weight is 0.5)
...
13 contributors increase the score value from 8.00 to 9.60
...
Score: **3.15**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2571**
