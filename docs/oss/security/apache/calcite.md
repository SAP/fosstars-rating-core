...
**Score**: 4.59, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 2.81, confidence is 10.0 (max), importance is 0.5 (medium)
...
137 commits in the last 3 months results to 10.00 points
10 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 137
1.  Number of contributors in the last three months: 10

### Project popularity

Score: 2.81, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2242
1.  Number of watchers for a GitHub repository: 169
...
1.  A set of programming languages: JAVA, RUBY, PYTHON, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/calcite/security/policy)
