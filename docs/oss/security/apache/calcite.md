...
1.  **[Project activity](#project-activity)**: **9.97** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **3.14** (weight is 0.5)
...
Score: **9.97**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

54 commits in the last 3 months results to 8.31 points
13 contributors increase the score value from 8.31 to 9.97
...
Score: **3.14**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2564**
