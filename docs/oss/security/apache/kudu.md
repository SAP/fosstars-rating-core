...
**Score**: 4.46, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 0.18, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 1.71, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.18, confidence is 10.0 (max), importance is 1.0 (high)
...
133 commits in the last 3 months results to 10.00 points
5 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 133
1.  Number of contributors in the last three months: 5

### Project popularity

Score: 1.71, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1309
1.  Number of watchers for a GitHub repository: 119
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/kudu)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/kudu/security/policy)
