...
1.  **[Project popularity](#project-popularity)**: 7.81, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 7.81, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6139
1.  Number of watchers for a GitHub repository: 501
