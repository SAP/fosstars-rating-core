...
1.  **[Project popularity](#project-popularity)**: **8.33** (weight is 0.5)
...
384 commits in the last 3 months results to 10.00 points
14 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **384**
1.  Number of contributors in the last three months: **14**

### Project popularity

Score: **8.33**, confidence is 10.0 (max), weight is 0.5 (medium)
