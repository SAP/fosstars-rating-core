...
**Score**: 6.07, where max score value is 10.0
...
1.  **[Security awareness](#security-awareness)**: 5.5, confidence is 10.0 (max), importance is 0.9 (high)
...
Score: 5.5, confidence is 10.0 (max), importance is 0.9 (high)
...
1.  Info about vulnerabilities: 27 vulnerabilities
...
1.  Number of stars for a GitHub repository: 11201
1.  Number of watchers for a GitHub repository: 1028
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/hadoop/security/policy)
