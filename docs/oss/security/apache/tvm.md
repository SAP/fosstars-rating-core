...
**Score**: 5.25, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 0.62, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 7.41, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.62, confidence is 10.0 (max), importance is 1.0 (high)
...
398 commits in the last 3 months results to 10.00 points

The sub-score uses 2 features:

1.  Number of commits in the last three months: 398
1.  Number of contributors in the last three months: 1

### Project popularity

Score: 7.41, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6135
...
1.  A set of programming languages: C, CPP, JAVA, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/tvm/security/policy)
