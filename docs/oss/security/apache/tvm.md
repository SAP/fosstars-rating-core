...
1.  **[Project popularity](#project-popularity)**: **8.18** (weight is 0.5)
...
439 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **439**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **8.18**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6909**
