...
1.  **[Project popularity](#project-popularity)**: **7.57** (weight is 0.5)
...
363 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **363**
...
1.  Number of stars for a GitHub repository: **6292**
1.  Number of watchers for a GitHub repository: **384**
