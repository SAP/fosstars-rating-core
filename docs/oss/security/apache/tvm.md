...
1.  **[Security testing](#security-testing)**: **2.1** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **8.21** (weight is 0.5)
...
Score: **2.1**, confidence is 10.0 (max), weight is 1.0 (high)
...
454 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **454**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **8.21**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6930**
1.  Number of watchers for a GitHub repository: **383**
