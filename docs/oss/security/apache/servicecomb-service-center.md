...
1.  Number of stars for a GitHub repository: 1164
...
1.  A set of programming languages: JAVA, JAVASCRIPT, TYPESCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/servicecomb-service-center/security/policy)
