...
1.  **[Project activity](#project-activity)**: **7.2** (weight is 0.5)
...
Score: **7.2**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

39 commits in the last 3 months results to 6.00 points
6 contributors increase the score value from 6.00 to 7.20
...
1.  Number of stars for a GitHub repository: **1923**
