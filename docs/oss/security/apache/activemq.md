...
**Score**: 4.68, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 1.11, confidence is 10.0 (max), importance is 1.0 (high)
    1.  **[Dependency testing](#dependency-testing)**: 3.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 2.54, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.11, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Info about vulnerabilities: 32 vulnerabilities
...
73 commits in the last 3 months results to 10.00 points
9 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 73
1.  Number of contributors in the last three months: 9

### Project popularity

Score: 2.54, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1848
1.  Number of watchers for a GitHub repository: 207
...
1.  A set of programming languages: CPP, JAVA, SCALA, C_SHARP, PHP, RUBY, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/activemq/security/policy)
