...
1.  **[Project activity](#project-activity)**: **9.37** (weight is 0.5)
...
Score: **9.37**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

58 commits in the last 3 months results to 8.92 points
2 contributors increase the score value from 8.92 to 9.37
...
1.  Number of stars for a GitHub repository: **2137**
1.  Number of watchers for a GitHub repository: **184**
