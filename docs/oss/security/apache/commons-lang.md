...
**Score**: 6.22, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 2.67, confidence is 10.0 (max), importance is 0.5 (medium)
...
134 commits in the last 3 months results to 10.00 points
5 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 134
1.  Number of contributors in the last three months: 5

### Project popularity

Score: 2.67, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2054
