...
1.  **[Project activity](#project-activity)**: **3.89** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **2.09** (weight is 0.5)
...
Score: **3.89**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

23 commits in the last 3 months results to 3.54 points
4 contributors increase the score value from 3.54 to 3.89
...
Score: **2.09**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1693**
