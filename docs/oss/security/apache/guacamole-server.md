...
**Score**: 4.43, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 1.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 7.75, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.97, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.0, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 7.75, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

42 commits in the last 3 months results to 6.46 points
6 contributors increase the score value from 6.46 to 7.75
...
Score: 1.97, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  A set of programming languages: C, CPP, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/guacamole-server)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/guacamole-server/security/policy)
