...
1.  Number of stars for a GitHub repository: **45107**
1.  Number of watchers for a GitHub repository: **2033**
...
1.  A set of programming languages: **JAVASCRIPT, TYPESCRIPT, OTHER**
1.  Is it included to OSS-Fuzz? **No**
...
4.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/echarts/security/policy)
