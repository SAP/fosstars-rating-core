...
1.  **[Project activity](#project-activity)**: 2.31, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 4.18, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.31, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 4.18, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 3342
...
1.  A set of programming languages: JAVA, SCALA, PYTHON, JAVASCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/rocketmq-externals/security/policy)
