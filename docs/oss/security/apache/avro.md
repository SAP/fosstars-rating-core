...
1.  **[Project activity](#project-activity)**: **8.4** (weight is 0.5)
...
Score: **8.4**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

52 commits in the last 3 months results to 8.00 points
2 contributors increase the score value from 8.00 to 8.40
...
1.  Number of stars for a GitHub repository: **1782**
...
1.  A set of package managers: **MAVEN, NPM, YARN, RUBYGEMS, COMPOSER**
1.  Does it use nohttp? **No**
