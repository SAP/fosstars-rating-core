...
1.  **[Security testing](#security-testing)**: 2.67, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 7.62, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 2.1, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.67, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 7.62, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

45 commits in the last 3 months results to 6.92 points
4 contributors increase the score value from 6.92 to 7.62
...
Score: 2.1, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1745
...
1.  A set of programming languages: C, CPP, JAVA, C_SHARP, PHP, RUBY, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
1.  A set of package managers: MAVEN, COMPOSER
1.  Does it use nohttp? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/avro/security/policy)
