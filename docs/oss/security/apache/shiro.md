...
**Score**: 5.0, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 4.72, confidence is 10.0 (max), importance is 1.0 (high)
    1.  **[Dependency testing](#dependency-testing)**: 9.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[Dependabot score](#dependabot-score)**: 6.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[OWASP Dependency Check score](#owasp-dependency-check-score)**: 3.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 4.25, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 4.09, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 4.72, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Info about vulnerabilities: 9 vulnerabilities
...
Score: 4.25, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

23 commits in the last 3 months results to 3.54 points
6 contributors increase the score value from 3.54 to 4.25

The sub-score uses 2 features:

1.  Number of commits in the last three months: 23
1.  Number of contributors in the last three months: 6

### Project popularity

Score: 4.09, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 3308
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/shiro/security/policy)
