...
1.  **[Project popularity](#project-popularity)**: 2.14, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.14, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1733
1.  Number of watchers for a GitHub repository: 121
