...
1.  **[Project popularity](#project-popularity)**: **2.23** (weight is 0.5)
...
Score: **2.23**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1822**
