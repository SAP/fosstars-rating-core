...
**Score**: 4.23, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 0.22, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 1.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[LGTM score](#lgtm-score)**: 1.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Vulnerability discovery and security testing](#vulnerability-discovery-and-security-testing)**: 0.0, confidence is 10.0 (max), importance is 0.6 (medium)
    1.  **[Security testing](#security-testing)**: 0.22, confidence is 10.0 (max), importance is 1.0 (high)
        ...
        1.  **[Memory-safety testing](#memory-safety-testing)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[nohttp tool](#nohttp-tool)**: 0.0, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project activity](#project-activity)**: 9.78, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Community commitment](#community-commitment)**: 7.0, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.94, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.22, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Info about vulnerabilities: 4 vulnerabilities
...
Score: 9.78, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of commits in the last three months: 248
...
Score: 1.94, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1411
1.  Number of watchers for a GitHub repository: 159
...
1.  A set of programming languages: C, CPP, JAVA, PHP, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
