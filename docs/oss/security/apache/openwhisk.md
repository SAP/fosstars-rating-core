...
1.  **[Security testing](#security-testing)**: 0.8, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 3.54, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 5.92, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.54, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 5.92, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 5115
1.  Number of watchers for a GitHub repository: 242
...
1.  A set of programming languages: JAVA, SCALA, C_SHARP, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
1.  A set of package managers: GRADLE
1.  Does it use nohttp? No
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/openwhisk)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/openwhisk/security/policy)
