...
1.  **[Project popularity](#project-popularity)**: **6.15** (weight is 0.5)
...
1.  Number of stars for a GitHub repository: **5343**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, SCALA, C_SHARP, PYTHON, JAVASCRIPT, OTHER**
