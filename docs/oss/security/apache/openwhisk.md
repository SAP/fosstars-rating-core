...
1.  **[Project popularity](#project-popularity)**: **5.97** (weight is 0.5)
...
Score: **5.97**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **5162**
...
1.  A set of package managers: **GRADLE, NPM, YARN**
1.  Does it use nohttp? **No**
