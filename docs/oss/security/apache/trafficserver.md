...
1.  **[Security testing](#security-testing)**: **0.62** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.78** (weight is 0.5)
...
Score: **0.62**, confidence is 10.0 (max), weight is 1.0 (high)
...
123 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **123**
...
1.  Number of stars for a GitHub repository: **1247**
