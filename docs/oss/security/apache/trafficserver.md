...
1.  **[Security testing](#security-testing)**: 2.18, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Memory-safety testing](#memory-safety-testing)**: 7.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 1.76, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.18, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Info about vulnerabilities: 33 vulnerabilities
...
82 commits in the last 3 months results to 10.00 points

The sub-score uses 2 features:

1.  Number of commits in the last three months: 82
1.  Number of contributors in the last three months: 1

### Project popularity

Score: 1.76, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1225
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/trafficserver/security/policy)
