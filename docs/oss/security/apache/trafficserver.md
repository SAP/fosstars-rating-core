...
1.  **[Security testing](#security-testing)**: **3.06** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.85** (weight is 0.5)
...
Score: **3.06**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Info about vulnerabilities: **41 vulnerabilities, [details below](#known-vulnerabilities)**
...
1.  Number of stars for a GitHub repository: **1320**
