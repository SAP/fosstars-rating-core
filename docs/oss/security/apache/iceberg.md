...
1.  **[Project popularity](#project-popularity)**: **1.49** (weight is 0.5)
...
276 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **276**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **1.49**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1162**
...
5.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/iceberg/security/policy)
