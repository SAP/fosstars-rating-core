...
1.  **[Project popularity](#project-popularity)**: 3.04, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.04, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2396
