...
**Score**: 4.75, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 5.9, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 5.9, confidence is 10.0 (max), importance is 0.5 (medium)
