...
1.  **[Project popularity](#project-popularity)**: **4.99** (weight is 0.5)
...
213 commits in the last 3 months results to 10.00 points
...
Score: **4.99**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4210**
