...
1.  **[Project popularity](#project-popularity)**: 4.75, confidence is 10.0 (max), importance is 0.5 (medium)
...
505 commits in the last 3 months results to 10.00 points
5 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 505
1.  Number of contributors in the last three months: 5

### Project popularity

Score: 4.75, confidence is 10.0 (max), importance is 0.5 (medium)
