...
1.  **[Project activity](#project-activity)**: 3.39, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.43, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.39, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.43, confidence is 10.0 (max), importance is 0.5 (medium)
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/rocketmq-spring/security/policy)
