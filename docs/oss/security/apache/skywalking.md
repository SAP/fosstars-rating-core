...
1.  Number of stars for a GitHub repository: **16080**
1.  Number of watchers for a GitHub repository: **839**
...
1.  A set of programming languages: **JAVA, SCALA, PHP, PYTHON, TYPESCRIPT, GO, OTHER**
1.  Is it included to OSS-Fuzz? **No**
...
5.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/skywalking/security/policy)
