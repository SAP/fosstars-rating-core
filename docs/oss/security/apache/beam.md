...
**Score**: 4.71, where max score value is 10.0
...
1.  Number of commits in the last three months: 1352
1.  Number of contributors in the last three months: 93
...
1.  Number of stars for a GitHub repository: 4206
...
1.  A set of programming languages: C, JAVA, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
