...
1.  **[Project popularity](#project-popularity)**: **5.42** (weight is 0.5)
...
902 commits in the last 3 months results to 10.00 points
65 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **902**
1.  Number of contributors in the last three months: **65**

### Project popularity

Score: **5.42**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4574**
...
1.  A set of package managers: **MAVEN, GRADLE, NPM, YARN**
1.  Does it use nohttp? **No**
