...
**Score**: 4.14, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.4, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 4.8, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 3.83, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.4, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Number of stars for a GitHub repository: 2915
...
1.  A set of programming languages: C, CPP, JAVA, SCALA, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/kylin/security/policy)
