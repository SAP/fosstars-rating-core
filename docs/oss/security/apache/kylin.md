...
1.  **[Project activity](#project-activity)**: **4.8** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **3.89** (weight is 0.5)
...
5 contributors increase the score value from 4.00 to 4.80
...
1.  Number of stars for a GitHub repository: **2966**
