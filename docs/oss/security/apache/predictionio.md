...
1.  Number of stars for a GitHub repository: 12474
1.  Number of watchers for a GitHub repository: 781
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/predictionio/security/policy)
