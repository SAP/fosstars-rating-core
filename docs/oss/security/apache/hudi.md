...
**Score**: 5.68, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 5.8, confidence is 10.0 (max), importance is 0.5 (medium)
...
112 commits in the last 3 months results to 10.00 points
3 contributors increase the score value from 10.00 to 11.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 112
1.  Number of contributors in the last three months: 3

### Project popularity

Score: 5.8, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1629
1.  Number of watchers for a GitHub repository: 1252
...
1.  A set of programming languages: JAVA, SCALA, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/hudi/security/policy)
