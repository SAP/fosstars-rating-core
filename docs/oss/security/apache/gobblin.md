...
Score: **2.43**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1853**
...
1.  A set of programming languages: **CPP, JAVA, PYTHON, JAVASCRIPT, OTHER**
1.  Is it included to OSS-Fuzz? **No**
...
5.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/gobblin/security/policy)
