...
1.  **[Project popularity](#project-popularity)**: **2.51** (weight is 0.5)
...
6 contributors increase the score value from 7.54 to 9.05
...
Score: **2.51**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1937**
