...
1.  **[Security testing](#security-testing)**: **2.14** (weight is 1.0)
...
Score: **2.14**, confidence is 10.0 (max), weight is 1.0 (high)
...
587 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **587**
...
1.  Number of stars for a GitHub repository: **9233**
1.  Number of watchers for a GitHub repository: **409**
