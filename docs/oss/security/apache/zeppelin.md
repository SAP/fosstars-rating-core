...
1.  **[Project popularity](#project-popularity)**: **6.38** (weight is 0.5)
...
3 contributors increase the score value from 9.38 to 10.32
...
Score: **6.38**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **5255**
