...
1.  **[Project popularity](#project-popularity)**: **6.46** (weight is 0.5)
...
Score: **2.73**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **5337**
