...
1.  **[Project activity](#project-activity)**: 0.46, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 3.66, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.46, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.66, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of watchers for a GitHub repository: 199
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/dubbo-admin/security/policy)
