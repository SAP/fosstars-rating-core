...
**Score**: **4.49**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.95** (weight is 0.5)
...
Score: **3.95**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3279**
