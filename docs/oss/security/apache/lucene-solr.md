...
1.  **[Project popularity](#project-popularity)**: 5.08, confidence is 10.0 (max), importance is 0.5 (medium)
...
31 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 268
1.  Number of contributors in the last three months: 31
...
1.  Number of stars for a GitHub repository: 3969
1.  Number of watchers for a GitHub repository: 332
...
1.  A set of programming languages: CPP, JAVA, RUBY, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/lucene-solr/security/policy)
