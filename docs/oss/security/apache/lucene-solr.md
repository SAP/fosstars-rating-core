...
1.  **[Project popularity](#project-popularity)**: **5.24** (weight is 0.5)
...
Score: **5.24**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4146**
