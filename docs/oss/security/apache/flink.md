...
**Score**: 5.87, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.62, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 2.62, confidence is 10.0 (max), importance is 1.0 (high)
...
33 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 1430
1.  Number of contributors in the last three months: 33
...
1.  Number of stars for a GitHub repository: 15135
...
1.  A set of programming languages: CPP, JAVA, SCALA, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/flink/security/policy)
