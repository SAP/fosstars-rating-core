...
**Score**: 5.92, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.89, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 2.89, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Number of commits in the last three months: 1007
...
1.  Number of stars for a GitHub repository: 13980
1.  Number of watchers for a GitHub repository: 915
...
1.  A set of programming languages: CPP, JAVA, SCALA, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
