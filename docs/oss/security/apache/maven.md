...
1.  **[Project popularity](#project-popularity)**: **3.36** (weight is 0.5)
...
7 contributors increase the score value from 4.77 to 5.72
...
Score: **3.36**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2664**
1.  Number of watchers for a GitHub repository: **208**
