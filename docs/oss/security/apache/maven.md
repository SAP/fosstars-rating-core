...
1.  **[Project popularity](#project-popularity)**: **3.27** (weight is 0.5)
...
7 contributors increase the score value from 9.38 to 11.26
...
Score: **3.27**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2572**
