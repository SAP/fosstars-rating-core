...
**Score**: 5.64, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 9.97, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 3.07, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Info about vulnerabilities: 7 vulnerabilities
...
Score: 9.97, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

54 commits in the last 3 months results to 8.31 points
7 contributors increase the score value from 8.31 to 9.97
...
Score: 3.07, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2379
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/maven/security/policy)
