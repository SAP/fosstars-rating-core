...
1.  **[Project popularity](#project-popularity)**: **3.13** (weight is 0.5)
...
7 contributors increase the score value from 7.85 to 9.42
...
Score: **3.13**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2429**
1.  Number of watchers for a GitHub repository: **211**
