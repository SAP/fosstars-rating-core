...
**Score**: 4.32, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 2.96, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.96, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2404
1.  Number of watchers for a GitHub repository: 168
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/curator/security/policy)
