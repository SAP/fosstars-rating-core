...
**Score**: 4.05, where max score value is 10.0

**Confidence**: High (9.59, where max confidence value is 10.0)
...
1.  **[Security testing](#security-testing)**: 0.8, confidence is 8.89 (low), importance is 1.0 (high)
    1.  **[Dependency testing](#dependency-testing)**: 0.0, confidence is 5.0 (low), importance is 1.0 (high)
        1.  **[Dependabot score](#dependabot-score)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[OWASP Dependency Check score](#owasp-dependency-check-score)**: 0.0, confidence is 0.0 (min), importance is 1.0 (high)
...
1.  **[Security awareness](#security-awareness)**: 5.0, confidence is 9.41 (high), importance is 0.9 (high)
1.  **[Unpatched vulnerabilities](#unpatched-vulnerabilities)**: 10.0, confidence is 10.0 (max), importance is 0.8 (high)
1.  **[Vulnerability discovery and security testing](#vulnerability-discovery-and-security-testing)**: 0.0, confidence is 9.44 (high), importance is 0.6 (medium)
    1.  **[Security testing](#security-testing)**: 0.8, confidence is 8.89 (low), importance is 1.0 (high)
        1.  **[Dependency testing](#dependency-testing)**: 0.0, confidence is 5.0 (low), importance is 1.0 (high)
            1.  **[Dependabot score](#dependabot-score)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
            1.  **[OWASP Dependency Check score](#owasp-dependency-check-score)**: 0.0, confidence is 0.0 (min), importance is 1.0 (high)
        ...
        1.  **[Memory-safety testing](#memory-safety-testing)**: N/A, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[nohttp tool](#nohttp-tool)**: 0.0, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project activity](#project-activity)**: 3.83, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Community commitment](#community-commitment)**: 7.0, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.45, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.8, confidence is 8.89 (low), importance is 1.0 (high)
...
Score: 5.0, confidence is 9.41 (high), importance is 0.9 (high)
...
1.  Info about vulnerabilities: 77 vulnerabilities

### Vulnerability discovery and security testing

Score: 0.0, confidence is 9.44 (high), importance is 0.6 (medium)
...
Score: 3.83, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.45, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1027
...
1.  A set of programming languages: JAVA, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
Score: 0.0, confidence is 0.0 (min), importance is 1.0 (high)
