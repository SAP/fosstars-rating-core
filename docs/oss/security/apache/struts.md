...
**Score**: 3.55, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 0.32, confidence is 8.89 (low), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 1.47, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.32, confidence is 8.89 (low), importance is 1.0 (high)
...
1.  Info about vulnerabilities: 80 vulnerabilities
...
Score: 1.47, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1051
