...
**Score**: 6.5, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 8.87, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 8.87, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6722
1.  Number of watchers for a GitHub repository: 645
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/shardingsphere-elasticjob/security/policy)
