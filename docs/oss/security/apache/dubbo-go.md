...
1.  **[Project popularity](#project-popularity)**: 3.06, confidence is 10.0 (max), importance is 0.5 (medium)
...
294 commits in the last 3 months results to 10.00 points
30 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 294
1.  Number of contributors in the last three months: 30

### Project popularity

Score: 3.06, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2610
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/dubbo-go/security/policy)
