...
1.  **[Project popularity](#project-popularity)**: **3.18** (weight is 0.5)
...
190 commits in the last 3 months results to 10.00 points
...
Score: **3.18**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2723**
1.  Number of watchers for a GitHub repository: **138**
