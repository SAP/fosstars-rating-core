...
**Score**: 4.15, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 1.32, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.32, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1003
1.  Number of watchers for a GitHub repository: 94
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/opennlp/security/policy)
