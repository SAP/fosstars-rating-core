...
**Score**: 3.3, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 1.08, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.08, confidence is 10.0 (max), importance is 0.5 (medium)
