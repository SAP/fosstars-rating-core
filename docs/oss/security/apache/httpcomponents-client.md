...
1.  **[Vulnerability discovery and security testing](#vulnerability-discovery-and-security-testing)**: **2.0** (weight is 0.6)
    1.  **[Security testing](#security-testing)**: **6.18** (weight is 1.0)
        ...
        1.  **[Memory-safety testing](#memory-safety-testing)**: **N/A** (weight is 1.0)
        1.  **[nohttp tool](#nohttp-tool)**: **0.0** (weight is 0.2)
1.  **[Unpatched vulnerabilities](#unpatched-vulnerabilities)**: **2.0** (weight is 0.5)
...
1.  Number of stars for a GitHub repository: **1085**
...
1.  https://issues.apache.org/jira/browse/HTTPCLIENT-1973
