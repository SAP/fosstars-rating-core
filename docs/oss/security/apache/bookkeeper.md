...
1.  **[Project popularity](#project-popularity)**: 1.44, confidence is 10.0 (max), importance is 0.5 (medium)
...
3 contributors increase the score value from 9.85 to 10.83
...
Score: 1.44, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1105
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/bookkeeper/security/policy)
