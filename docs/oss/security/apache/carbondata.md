...
1.  **[Project popularity](#project-popularity)**: **1.6** (weight is 0.5)
...
7 contributors increase the score value from 5.23 to 6.28
...
Score: **1.6**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1178**
1.  Number of watchers for a GitHub repository: **128**
