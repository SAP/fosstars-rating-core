...
1.  **[Project popularity](#project-popularity)**: **5.71** (weight is 0.5)
...
309 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **309**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **5.71**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4952**
