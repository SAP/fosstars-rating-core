...
1.  **[Project popularity](#project-popularity)**: 4.8, confidence is 10.0 (max), importance is 0.5 (medium)
...
328 commits in the last 3 months results to 10.00 points

The sub-score uses 2 features:

1.  Number of commits in the last three months: 328
1.  Number of contributors in the last three months: 1

### Project popularity

Score: 4.8, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 4089
1.  Number of watchers for a GitHub repository: 212
...
1.  A set of programming languages: OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/apisix/security/policy)
