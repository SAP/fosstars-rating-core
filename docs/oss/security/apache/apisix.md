...
**Score**: **6.45**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **5.09** (weight is 0.5)
...
Score: **6.67**, confidence is 9.56 (high), weight is 1.0 (high)
...
346 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **346**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **5.09**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4358**
1.  Number of watchers for a GitHub repository: **221**
