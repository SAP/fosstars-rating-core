...
1.  **[Project activity](#project-activity)**: 3.69, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.57, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.69, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.57, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1240
...
1.  A set of programming languages: JAVA, SCALA, PYTHON, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/apache/parquet-mr/security/policy)
