...
1.  **[Project popularity](#project-popularity)**: **1.99** (weight is 0.5)
...
7 contributors increase the score value from 5.08 to 6.09
...
Score: **1.99**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1694**
