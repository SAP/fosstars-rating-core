...
1.  **[Project popularity](#project-popularity)**: 1.9, confidence is 10.0 (max), importance is 0.5 (medium)
...
13 contributors increase the score value from 8.77 to 10.52
...
Score: 1.9, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of watchers for a GitHub repository: 86
...
1.  A set of programming languages: JAVA, SCALA, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/eclipse-collections/security/policy)
