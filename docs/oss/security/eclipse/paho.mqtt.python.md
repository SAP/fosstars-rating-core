...
**Score**: 3.77, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 1.8, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 0.32, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.52, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.8, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 1.52, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of watchers for a GitHub repository: 76
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/paho.mqtt.python/security/policy)
