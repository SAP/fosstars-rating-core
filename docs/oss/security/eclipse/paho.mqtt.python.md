...
**Score**: **3.78**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **1.8** (weight is 1.0)
...
Score: **1.8**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **1294**
1.  Number of watchers for a GitHub repository: **75**
