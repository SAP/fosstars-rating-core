...
**Score**: 3.51, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 0.77, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.65, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.77, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.65, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1213
...
1.  A set of programming languages: C, CPP, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/mraa/security/policy)
