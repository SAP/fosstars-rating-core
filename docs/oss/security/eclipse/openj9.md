...
**Score**: 4.31, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 3.02, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Info about vulnerabilities: 10 vulnerabilities
...
810 commits in the last 3 months results to 10.00 points
55 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 810
1.  Number of contributors in the last three months: 55

### Project popularity

Score: 3.02, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2522
...
1.  A set of programming languages: C, CPP, JAVA, PHP, RUBY, PYTHON, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/openj9/security/policy)
