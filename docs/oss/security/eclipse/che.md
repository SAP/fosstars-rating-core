...
1.  **[Project popularity](#project-popularity)**: **7.39** (weight is 0.5)
...
113 commits in the last 3 months results to 10.00 points
...
Score: **7.39**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of watchers for a GitHub repository: **307**
