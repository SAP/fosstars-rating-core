...
**Score**: **6.24**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **7.46** (weight is 0.5)
...
Score: **7.46**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6435**
