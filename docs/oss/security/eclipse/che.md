...
**Score**: 5.46, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 7.38, confidence is 10.0 (max), importance is 0.5 (medium)
...
126 commits in the last 3 months results to 10.00 points
6 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 126
1.  Number of contributors in the last three months: 6

### Project popularity

Score: 7.38, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6342
1.  Number of watchers for a GitHub repository: 310
...
1.  A set of programming languages: C, CPP, JAVA, C_SHARP, PHP, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can fix the issues reported by LGTM for the project. More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/eclipse/che)
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/che/security/policy)
