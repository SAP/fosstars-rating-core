...
**Score**: 4.55, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 1.34, confidence is 10.0 (max), importance is 0.5 (medium)
...
62 commits in the last 3 months results to 9.54 points
7 contributors increase the score value from 9.54 to 11.45

The sub-score uses 2 features:

1.  Number of commits in the last three months: 62
1.  Number of contributors in the last three months: 7

### Project popularity

Score: 1.34, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1007
1.  Number of watchers for a GitHub repository: 101
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/paho.mqtt.c/security/policy)
