...
**Score**: 5.59, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 4.32, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 3.95, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 4.32, confidence is 10.0 (max), importance is 1.0 (high)
...
721 commits in the last 3 months results to 10.00 points
13 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 721
1.  Number of contributors in the last three months: 13

### Project popularity

Score: 3.95, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 3030
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/jetty.project/security/policy)
