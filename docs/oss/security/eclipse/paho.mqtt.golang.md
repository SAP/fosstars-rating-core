...
1.  **[Project activity](#project-activity)**: 2.26, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.67, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.26, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.67, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1459
1.  Number of watchers for a GitHub repository: 64
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/paho.mqtt.golang/security/policy)
