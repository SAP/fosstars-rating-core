...
1.  **[Project popularity](#project-popularity)**: 2.45, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.45, confidence is 10.0 (max), importance is 0.5 (medium)
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/paho.mqtt.android/security/policy)
