...
1.  **[Project popularity](#project-popularity)**: **1.24** (weight is 0.5)
...
Score: **1.24**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1000**
1.  Number of watchers for a GitHub repository: **72**
