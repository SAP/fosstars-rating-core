...
1.  **[Project popularity](#project-popularity)**: 5.16, confidence is 10.0 (max), importance is 0.5 (medium)
...
334 commits in the last 3 months results to 10.00 points
7 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 334
1.  Number of contributors in the last three months: 7

### Project popularity

Score: 5.16, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 4336
