...
1.  Number of stars for a GitHub repository: 11897
1.  Number of watchers for a GitHub repository: 826
...
1.  A set of programming languages: C, CPP, JAVA, SCALA, C_SHARP, RUBY, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/eclipse/deeplearning4j/security/policy)
