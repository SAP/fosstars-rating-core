...
**Score**: 6.4, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 5.11, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 8.0, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 5.11, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 8.0, confidence is 10.0 (max), importance is 1.0 (high)
...
2.  You can open a pull request to enable FindSecBugs for the project. More info:
    1.  [FindSecBugs home page](https://find-sec-bugs.github.io/)
3.  You can open a pull request to enable AddressSanitizer for the project. More info:
    1.  [About AdddressSanitizer](https://github.com/google/sanitizers/wiki/AddressSanitizer)
4.  You can open a pull request to enable MemorySanitizer for the project. More info:
    1.  [About AdddressSanitizer](https://github.com/google/sanitizers/wiki/MemorySanitizer)
5.  You can open a pull request to enable UndefinedBehaviorSanitizer for the project. More info:
    1.  [About AdddressSanitizer](https://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html)
6.  You can include the project to OSS-Fuzz. Then, the project is going to be regularly fuzzed. More info:
