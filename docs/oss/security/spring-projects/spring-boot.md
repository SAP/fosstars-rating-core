...
1.  **[Security testing](#security-testing)**: 3.12, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 3.12, confidence is 10.0 (max), importance is 1.0 (high)
...
1150 commits in the last 3 months results to 10.00 points
7 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 1150
...
1.  Number of stars for a GitHub repository: 52677
1.  Number of watchers for a GitHub repository: 3486
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-boot/security/policy)
