...
**Score**: 4.2, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 2.09, confidence is 10.0 (max), importance is 0.5 (medium)
...
4 contributors increase the score value from 5.23 to 5.75
...
Score: 2.09, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1571
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-session/security/policy)
