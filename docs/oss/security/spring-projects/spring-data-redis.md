...
1.  **[Project popularity](#project-popularity)**: 1.78, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.78, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1260
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-data-redis/security/policy)
