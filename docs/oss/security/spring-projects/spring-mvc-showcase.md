...
1.  **[Security testing](#security-testing)**: 2.72, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 6.73, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.72, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 6.73, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 4882
1.  Number of watchers for a GitHub repository: 553
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-mvc-showcase/security/policy)
