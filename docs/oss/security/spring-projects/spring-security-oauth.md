...
**Score**: **3.5**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **5.66** (weight is 0.5)
...
Score: **5.66**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4319**
