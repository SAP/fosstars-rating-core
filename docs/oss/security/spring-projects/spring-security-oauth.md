...
1.  **[Unpatched vulnerabilities](#unpatched-vulnerabilities)**: **0.0** (weight is 0.8)
...
Score: **0.0**, confidence is 10.0 (max), weight is 0.8 (high)
...
1.  Info about vulnerabilities: **7 vulnerabilities, [details below](#known-vulnerabilities)**
...
1.  Number of stars for a GitHub repository: **4384**
1.  Number of watchers for a GitHub repository: **405**
...
1.  [CVE-2016-4977](https://nvd.nist.gov/vuln/detail/CVE-2016-4977): Optional[When processing authorization requests using the whitelabel views in Spring Security OAuth 2.0.0 to 2.0.9 and 1.0.0 to 1.0.5, the response_type parameter value was executed as Spring SpEL which enabled a malicious user to trigger remote code execution via the crafting of the value for response_type.]
1.  [CVE-2018-1260](https://nvd.nist.gov/vuln/detail/CVE-2018-1260): Optional[Spring Security OAuth, versions 2.3 prior to 2.3.3, 2.2 prior to 2.2.2, 2.1 prior to 2.1.2, 2.0 prior to 2.0.15 and older unsupported versions contains a remote code execution vulnerability. A malicious user or attacker can craft an authorization request to the authorization endpoint that can lead to remote code execution when the resource owner is forwarded to the approval endpoint.]
