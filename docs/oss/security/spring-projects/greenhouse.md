...
**Score**: 3.98, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.4, confidence is 9.56 (high), importance is 1.0 (high)
...
Score: 2.4, confidence is 9.56 (high), importance is 1.0 (high)
...
1.  Number of stars for a GitHub repository: 1316
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/greenhouse/security/policy)
