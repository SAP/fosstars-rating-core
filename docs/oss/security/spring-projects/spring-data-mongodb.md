...
1.  **[Project activity](#project-activity)**: 6.94, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.81, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 6.94, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.81, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1231
1.  Number of watchers for a GitHub repository: 175
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-data-mongodb/security/policy)
