...
**Score**: **5.49**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **7.45** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **2.78** (weight is 0.5)
...
Score: **7.45**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

44 commits in the last 3 months results to 6.77 points
4 contributors increase the score value from 6.77 to 7.45
...
Score: **2.78**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2069**
