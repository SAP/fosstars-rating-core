...
**Score**: 5.17, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 8.12, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 2.68, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 8.12, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

48 commits in the last 3 months results to 7.38 points
4 contributors increase the score value from 7.38 to 8.12
...
Score: 2.68, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1965
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-data-jpa/security/policy)
