...
**Score**: 3.52, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 1.5, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.5, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  A set of programming languages: JAVA, RUBY, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-integration/security/policy)
