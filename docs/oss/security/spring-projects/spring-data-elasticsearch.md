...
**Score**: 5.49, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 3.25, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.25, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2341
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-data-elasticsearch/security/policy)
