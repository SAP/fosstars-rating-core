...
**Score**: 4.8, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 9.65, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 9.65, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

57 commits in the last 3 months results to 8.77 points
4 contributors increase the score value from 8.77 to 9.65
...
1.  Number of stars for a GitHub repository: 1212
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-kafka/security/policy)
