...
1.  **[Project popularity](#project-popularity)**: **7.41** (weight is 0.5)
...
237 commits in the last 3 months results to 10.00 points
6 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **237**
1.  Number of contributors in the last three months: **6**

### Project popularity

Score: **7.41**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **5906**
1.  Number of watchers for a GitHub repository: **452**
