...
**Score**: 4.66, where max score value is 10.0
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/spring-projects/spring-statemachine/security/policy)
