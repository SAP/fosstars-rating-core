...
1.  **[Project popularity](#project-popularity)**: **1.46** (weight is 0.5)
...
Score: **1.46**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1140**
