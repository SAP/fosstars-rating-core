...
1.  **[Security testing](#security-testing)**: **0.78** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.0** (weight is 0.5)
...
1.  Number of watchers for a GitHub repository: **277**
