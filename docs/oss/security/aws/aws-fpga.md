...
**Score**: 3.28, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 0.78, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 0.62, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.78, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 0.62, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1054
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-fpga/security/policy)
