...
1.  **[Project activity](#project-activity)**: 5.08, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 8.73, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 5.08, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 8.73, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 7611
1.  Number of watchers for a GitHub repository: 337
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/serverless-application-model/security/policy)
