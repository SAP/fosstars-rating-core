...
**Score**: 3.57, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 6.09, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.77, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 6.09, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

36 commits in the last 3 months results to 5.54 points
4 contributors increase the score value from 5.54 to 6.09

The sub-score uses 2 features:

1.  Number of commits in the last three months: 36
1.  Number of contributors in the last three months: 4

### Project popularity

Score: 1.77, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1384
1.  Number of watchers for a GitHub repository: 117
...
1.  A set of programming languages: GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/amazon-vpc-cni-k8s/security/policy)
