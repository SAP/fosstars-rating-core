...
**Score**: 5.82, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 5.93, confidence is 10.0 (max), importance is 0.5 (medium)
...
84 commits in the last 3 months results to 10.00 points

The sub-score uses 2 features:

1.  Number of commits in the last three months: 84
1.  Number of contributors in the last three months: 1

### Project popularity

Score: 5.93, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 5358
...
1.  A set of programming languages: JAVA, C_SHARP, RUBY, PYTHON, JAVASCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-sam-cli/security/policy)
