...
**Score**: 5.06, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 3.84, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 3.6, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[LGTM score](#lgtm-score)**: 9.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 9.05, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 4.51, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 3.84, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 9.05, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

56 commits in the last 3 months results to 8.62 points
2 contributors increase the score value from 8.62 to 9.05
...
Score: 4.51, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 3439
1.  Number of watchers for a GitHub repository: 321
...
Score: 9.0, confidence is 10.0 (max), importance is 1.0 (high)
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-sdk-java/security/policy)
