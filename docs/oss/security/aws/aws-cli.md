...
**Score**: 6.23, where max score value is 10.0
...
224 commits in the last 3 months results to 10.00 points
11 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 224
...
1.  Number of stars for a GitHub repository: 10521
1.  Number of watchers for a GitHub repository: 574
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-cli/security/policy)
