...
1.  **[Project popularity](#project-popularity)**: 2.3, confidence is 10.0 (max), importance is 0.5 (medium)
...
455 commits in the last 3 months results to 10.00 points
11 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 455
1.  Number of contributors in the last three months: 11

### Project popularity

Score: 2.3, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1549
...
1.  A set of programming languages: JAVA, C_SHARP, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-sdk-net/security/policy)
