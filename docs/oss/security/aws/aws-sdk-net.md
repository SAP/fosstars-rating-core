...
1.  **[Project popularity](#project-popularity)**: **2.32** (weight is 0.5)
...
428 commits in the last 3 months results to 10.00 points
10 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **428**
1.  Number of contributors in the last three months: **10**

### Project popularity

Score: **2.32**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1574**
...
1.  A set of package managers: **DOTNET**
1.  Does it use nohttp? **No**
