...
1.  **[Project activity](#project-activity)**: 0.48, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 1.86, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.48, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 1.86, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1523
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/amazon-ecs-cli/security/policy)
