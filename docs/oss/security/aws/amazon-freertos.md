...
**Score**: 4.18, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 2.83, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of commits in the last three months: 356
...
Score: 2.83, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2071
1.  Number of watchers for a GitHub repository: 228
