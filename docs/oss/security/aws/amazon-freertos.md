...
**Score**: 4.79, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 2.44, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 2.91, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.44, confidence is 10.0 (max), importance is 1.0 (high)
...
410 commits in the last 3 months results to 10.00 points
20 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 410
1.  Number of contributors in the last three months: 20

### Project popularity

Score: 2.91, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2165
...
1.  A set of programming languages: C, CPP, PYTHON, JAVASCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/amazon-freertos/security/policy)
