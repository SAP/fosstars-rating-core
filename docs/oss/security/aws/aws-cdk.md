...
**Score**: 5.67, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 6.67, confidence is 10.0 (max), importance is 0.5 (medium)
...
669 commits in the last 3 months results to 10.00 points
9 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 669
1.  Number of contributors in the last three months: 9

### Project popularity

Score: 6.67, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6008
...
1.  A set of programming languages: JAVA, C_SHARP, F_SHARP, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-cdk/security/policy)
