...
1.  **[Project popularity](#project-popularity)**: **6.92** (weight is 0.5)
...
568 commits in the last 3 months results to 10.00 points
6 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **568**
...
1.  Number of stars for a GitHub repository: **6233**
