...
1.  Number of commits in the last three months: 752
...
1.  Number of stars for a GitHub repository: 5299
...
1.  A set of programming languages: JAVA, C_SHARP, F_SHARP, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
