...
**Score**: 3.22, where max score value is 10.0
...
1.  Number of stars for a GitHub repository: 1293
...
1.  A set of programming languages: C, CPP, JAVA, C_SHARP, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
