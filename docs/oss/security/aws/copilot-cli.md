...
**Score**: 5.32, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 5.8, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 4.5, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 1.28, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 5.8, confidence is 10.0 (max), importance is 1.0 (high)
...
176 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

The sub-score uses 2 features:

1.  Number of commits in the last three months: 176
1.  Number of contributors in the last three months: 2

### Project popularity

Score: 1.28, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 1159
1.  Number of watchers for a GitHub repository: 37
...
1.  A set of programming languages: PYTHON, JAVASCRIPT, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
Score: 4.5, confidence is 10.0 (max), importance is 1.0 (high)
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/copilot-cli/security/policy)
