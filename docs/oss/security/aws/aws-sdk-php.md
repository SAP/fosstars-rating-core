...
**Score**: 5.24, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 4.0, confidence is 10.0 (max), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: N/A, confidence is 10.0 (max), importance is 1.0 (high)
        1.  **[LGTM score](#lgtm-score)**: N/A, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project popularity](#project-popularity)**: 5.91, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 5.91, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 5067
...
1.  A set of package managers: COMPOSER
1.  Does it use nohttp? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-sdk-php/security/policy)
