...
**Score**: 5.94, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 7.25, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 7.25, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 6381
1.  Number of watchers for a GitHub repository: 261
...
1.  A set of programming languages: RUBY, JAVASCRIPT, TYPESCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
1.  A set of package managers: NPM, YARN, RUBYGEMS
1.  Does it use nohttp? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-sdk-js/security/policy)
