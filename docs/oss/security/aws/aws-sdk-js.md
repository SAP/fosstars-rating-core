...
1.  **[Project popularity](#project-popularity)**: **7.33** (weight is 0.5)
...
69 commits in the last 3 months results to 10.00 points
...
Score: **7.33**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6456**
1.  Number of watchers for a GitHub repository: **262**
