...
**Score**: 3.92, where max score value is 10.0
...
1.  **[Project activity](#project-activity)**: 8.86, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 8.86, confidence is 10.0 (max), importance is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

48 commits in the last 3 months results to 7.38 points
11 contributors increase the score value from 7.38 to 8.86
...
1.  Number of stars for a GitHub repository: 1748
...
1.  A set of programming languages: C, PYTHON, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/amazon-ecs-agent/security/policy)
