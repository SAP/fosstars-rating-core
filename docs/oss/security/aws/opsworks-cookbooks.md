...
**Score**: 3.19, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 1.4, confidence is 10.0 (max), importance is 1.0 (high)
...
Score: 1.4, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  Number of stars for a GitHub repository: 1057
...
1.  A set of programming languages: RUBY, PYTHON, JAVASCRIPT, OTHER
1.  Is it included to OSS-Fuzz? No
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/opsworks-cookbooks/security/policy)
