...
**Score**: 6.06, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 8.35, confidence is 10.0 (max), importance is 0.5 (medium)
...
77 commits in the last 3 months results to 10.00 points
6 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 77
1.  Number of contributors in the last three months: 6

### Project popularity

Score: 8.35, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 7506
1.  Number of watchers for a GitHub repository: 252
...
5.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/chalice/security/policy)
