...
1.  **[Project popularity](#project-popularity)**: **1.19** (weight is 0.5)
...
270 commits in the last 3 months results to 10.00 points
7 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **270**
1.  Number of contributors in the last three months: **7**

### Project popularity

Score: **1.19**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1041**
...
1.  A set of programming languages: **JAVA, C_SHARP, F_SHARP, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER**
1.  Is it included to OSS-Fuzz? **No**
...
5.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/jsii/security/policy)
