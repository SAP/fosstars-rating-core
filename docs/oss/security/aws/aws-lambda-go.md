...
**Score**: **3.61**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.83** (weight is 0.5)
...
Score: **2.83**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2626**
