...
**Score**: 2.97, where max score value is 10.0
...
1.  **[Security testing](#security-testing)**: 0.0, confidence is 9.56 (high), importance is 1.0 (high)
    ...
    1.  **[Static analysis](#static-analysis)**: 0.0, confidence is 8.0 (low), importance is 1.0 (high)
...
1.  **[Security awareness](#security-awareness)**: 0.5, confidence is 10.0 (max), importance is 0.9 (high)
1.  **[Unpatched vulnerabilities](#unpatched-vulnerabilities)**: 10.0, confidence is 10.0 (max), importance is 0.8 (high)
1.  **[Vulnerability discovery and security testing](#vulnerability-discovery-and-security-testing)**: 0.0, confidence is 9.78 (high), importance is 0.6 (medium)
    1.  **[Security testing](#security-testing)**: 0.0, confidence is 9.56 (high), importance is 1.0 (high)
        1.  **[Dependency testing](#dependency-testing)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
            1.  **[Dependabot score](#dependabot-score)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
            1.  **[OWASP Dependency Check score](#owasp-dependency-check-score)**: 0.0, confidence is 10.0 (max), importance is 1.0 (high)
...
1.  **[Project activity](#project-activity)**: 0.92, confidence is 10.0 (max), importance is 0.5 (medium)
1.  **[Project popularity](#project-popularity)**: 2.71, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 0.0, confidence is 9.56 (high), importance is 1.0 (high)
...
Score: 0.5, confidence is 10.0 (max), importance is 0.9 (high)
...
Score: 0.0, confidence is 9.78 (high), importance is 0.6 (medium)
...
Score: 0.92, confidence is 10.0 (max), importance is 0.5 (medium)
...
Score: 2.71, confidence is 10.0 (max), importance is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: 2507
1.  Number of watchers for a GitHub repository: 60
...
1.  A set of programming languages: GO
1.  Is it included to OSS-Fuzz? No
...
Score: 0.0, confidence is 8.0 (low), importance is 1.0 (high)
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-lambda-go/security/policy)
