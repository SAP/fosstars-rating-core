...
**Score**: 5.39, where max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: 1.56, confidence is 10.0 (max), importance is 0.5 (medium)
...
269 commits in the last 3 months results to 10.00 points
24 contributors increase the score value from 10.00 to 12.00

The sub-score uses 2 features:

1.  Number of commits in the last three months: 269
...
1.  Number of stars for a GitHub repository: 1278
...
1.  A set of programming languages: PYTHON, GO, OTHER
1.  Is it included to OSS-Fuzz? No
...
4.  You can open a pull request to add a security policy for the project. More info:
    ...
    3.  [Suggest a security policy for the project](https://github.com/aws/aws-controllers-k8s/security/policy)
