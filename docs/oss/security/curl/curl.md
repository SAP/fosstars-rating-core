...
**Score**: **6.1**, max score value is 10.0
...
404 commits in the last 3 months results to 10.00 points
9 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **404**
...
1.  Number of stars for a GitHub repository: **19372**
