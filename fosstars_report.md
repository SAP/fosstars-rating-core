...
1.  **[Project activity](#project-activity)**: **5.38** (weight is 0.5)
...
Score: **5.38**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 45
