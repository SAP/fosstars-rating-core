...
1.  **[Security testing](#security-testing)**: **8.18** (weight is 1.0)
...
3.  You can add OWASP Dependency Check to the project's build pipeline.
    More info:
...
4.  You can set a CVSS threshold for vulnerabilities reported by OWASP Dependency Check.
    More info:
    1.  [OWASP Dependnecy Check](https://jeremylong.github.io/DependencyCheck/)
...
Score: **8.18**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **0.08**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **40**
