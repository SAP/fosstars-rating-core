...
1.  **[Security testing](#security-testing)**: **7.23** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **5.91** (weight is 1.0)
...
1.  **Number of stars for a GitHub repository:** 50
