...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/pallets/flask)
...
Score: **6.14**, confidence is 10.0 (max), weight is 1.0 (high)
...
85 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 85
...
1.  **Number of projects on GitHub that use an open source project:** 858647
1.  **Number of stars for a GitHub repository:** 56910
1.  **Number of watchers for a GitHub repository:** 2221
...
1.  [CVE-2019-1010083](https://nvd.nist.gov/vuln/detail/CVE-2019-1010083): The Pallets Project Flask before 1.0 is affected by: unexpected memory usage. The impact is: denial of service. The attack vector is: crafted encoded JSON data. The fixed version is: 1. NOTE: this may overlap CVE-2018-1000656.
