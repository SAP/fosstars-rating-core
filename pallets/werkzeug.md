...
1.  **[Security testing](#security-testing)**: **6.59** (weight is 1.0)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/pallets/werkzeug)
...
Score: **6.59**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Number of projects on GitHub that use an open source project:** 600490
1.  **Number of stars for a GitHub repository:** 5855
...
1.  [CVE-2016-10516](https://nvd.nist.gov/vuln/detail/CVE-2016-10516): Cross-site scripting (XSS) vulnerability in the render_full function in debug/tbtools.py in the debugger in Pallets Werkzeug before 0.11.11 (as used in Pallets Flask and other products) allows remote attackers to inject arbitrary web script or HTML via a field that contains an exception message.
1.  [CVE-2019-14322](https://nvd.nist.gov/vuln/detail/CVE-2019-14322): In Pallets Werkzeug before 0.15.5, SharedDataMiddleware mishandles drive names (such as C:) in Windows pathnames.
1.  [CVE-2019-14806](https://nvd.nist.gov/vuln/detail/CVE-2019-14806): Pallets Werkzeug before 0.15.3, when used with Docker, has insufficient debugger PIN randomness because Docker containers share the same machine id.
1.  [CVE-2020-28724](https://nvd.nist.gov/vuln/detail/CVE-2020-28724): Open redirect vulnerability in werkzeug before 0.11.6 via a double slash in the URL.
