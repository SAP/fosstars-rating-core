...
**Score**: **3.9**, max score value is 10.0
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/scipy/scipy)
...
318 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 318
...
1.  **Number of projects on GitHub that use an open source project:** 392990
1.  **Number of stars for a GitHub repository:** 8691
...
1.  [CVE-2013-4251](https://nvd.nist.gov/vuln/detail/CVE-2013-4251): The scipy.weave component in SciPy before 0.12.1 creates insecure temporary directories.
