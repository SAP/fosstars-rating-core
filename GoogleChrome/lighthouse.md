...
1.  [Suggest a security policy for the project](https://github.com/GoogleChrome/lighthouse/security/policy)
...
114 commits in the last 3 months results to 10.00 points
...
1.  **Number of projects on GitHub that use an open source project:** 10868
1.  **Number of stars for a GitHub repository:** 25008
