...
1.  [Suggest a security policy for the project](https://github.com/FasterXML/jackson-core/security/policy)
...
1.  **Number of projects on GitHub that use an open source project:** 204427
1.  **Number of stars for a GitHub repository:** 1983
