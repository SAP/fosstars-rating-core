...
728 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 728
...
1.  **Number of stars for a GitHub repository:** 20136
1.  **Number of watchers for a GitHub repository:** 605
...
1.  **Is it included to OSS-Fuzz?** Yes
1.  **Programming languages:** C, CPP, PYTHON, JAVASCRIPT, GO, OTHER
