...
1.  **[Security testing](#security-testing)**: **1.41** (weight is 1.0)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/pandas-dev/pandas)
...
Score: **1.41**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Number of projects on GitHub that use an open source project:** 530063
1.  **Number of stars for a GitHub repository:** 31375
1.  **Number of watchers for a GitHub repository:** 1118
...
1.  [CVE-2020-13091](https://nvd.nist.gov/vuln/detail/CVE-2020-13091): ** DISPUTED ** pandas through 1.0.3 can unserialize and execute commands from an untrusted file that is passed to the read_pickle() function, if __reduce__ makes an os.system call. NOTE: third parties dispute this issue because the read_pickle() function is documented as unsafe and it is the user's responsibility to use the function in a secure manner.
