...
1.  [Suggest a security policy for the project](https://github.com/keras-team/keras/security/policy)
...
1.  **Number of stars for a GitHub repository:** 52884
1.  **Number of watchers for a GitHub repository:** 2004
