...
**Score**: **7.47**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **8.23** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **8.11** (weight is 1.0)
        1.  **[How a project uses CodeQL](#how-a-project-uses-codeql)**: **10.0** (weight is 1.0)
            
        1.  **[Bandit score](#bandit-score)**: **6.0** (weight is 0.35)
            
        1.  **[FindSecBugs score](#findsecbugs-score)**: **N/A** (weight is 0.35)
            
        1.  **[How a project uses Pylint](#how-a-project-uses-pylint)**: **6.0** (weight is 0.35)
...
1.  **[Project popularity](#project-popularity)**: **3.98** (weight is 0.5)
...
Score: **8.23**, confidence is 10.0 (max), weight is 1.0 (high)
...
154 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 154
1.  **Number of contributors in the last three months:** 6


### Project popularity

Score: **3.98**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 2669
1.  **Number of stars for a GitHub repository:** 1911
1.  **Number of watchers for a GitHub repository:** 87
...
Score: **8.11**, confidence is 10.0 (max), weight is 1.0 (high)
