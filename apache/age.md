...
Score: **1.67**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1481
1.  **Number of watchers for a GitHub repository:** 58
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, JAVA, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
...
1.  **Does it use nohttp?** No
1.  **Package managers:** NPM, YARN, GOMODULES
