...
8 contributors increase the score value from 7.38 to 8.86
...
1.  **Number of projects on GitHub that use an open source project:** 206130
1.  **Number of stars for a GitHub repository:** 54199
1.  **Number of watchers for a GitHub repository:** 2019
