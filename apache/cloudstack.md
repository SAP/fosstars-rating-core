...
1.  **[Security testing](#security-testing)**: **5.25** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **1.56** (weight is 1.0)
...
Score: **5.25**, confidence is 10.0 (max), weight is 1.0 (high)
...
217 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 217
1.  **Number of contributors in the last three months:** 6


### Project popularity

Score: **1.81**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1340
