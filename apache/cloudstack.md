...
**Score**: **5.31**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **4.09** (weight is 1.0)
...
Score: **4.09**, confidence is 10.0 (max), weight is 1.0 (high)
...
305 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 305
...
1.  **Number of stars for a GitHub repository:** 1077
