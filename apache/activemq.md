...
1.  **[Security testing](#security-testing)**: **0.71** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.79** (weight is 0.5)
...
Score: **0.71**, confidence is 10.0 (max), weight is 1.0 (high)
...
6 contributors increase the score value from 8.92 to 10.71
...
Score: **2.79**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2126
