...
**Score**: **4.23**, max score value is 10.0
...
Score: **1.33**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1144
1.  **Number of watchers for a GitHub repository:** 56
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** PYTHON, TYPESCRIPT, OTHER
