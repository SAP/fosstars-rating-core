...
499 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 499
...
1.  **Number of projects on GitHub that use an open source project:** 1962
1.  **Number of stars for a GitHub repository:** 3187
