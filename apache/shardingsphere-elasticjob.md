...
1.  **[Project popularity](#project-popularity)**: **9.95** (weight is 0.5)
...
Score: **9.95**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 7814
