...
**Score**: **6.25**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **4.48** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **9.56** (weight is 0.5)
...
Score: **4.48**, confidence is 10.0 (max), weight is 1.0 (high)
...
521 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 521
1.  **Number of contributors in the last three months:** 23


### Project popularity

Score: **9.56**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 48
1.  **Number of stars for a GitHub repository:** 8429
...
1.  **Is it included to OSS-Fuzz?** Yes
1.  **Programming languages:** C, CPP, JAVA, C_SHARP, RUBY, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
...
1.  **Does it use nohttp?** No
1.  **Package managers:** MAVEN, NPM, YARN, RUBYGEMS
