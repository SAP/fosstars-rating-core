...
**Score**: **6.55**, max score value is 10.0
...
511 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 511
...
1.  **Number of projects on GitHub that use an open source project:** 89
1.  **Number of stars for a GitHub repository:** 11106
...
1.  **Does it use nohttp?** No
1.  **Package managers:** MAVEN, NPM, YARN, RUBYGEMS, GOMODULES
