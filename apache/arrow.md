...
**Score**: **6.26**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **9.66** (weight is 0.5)
...
564 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 564
1.  **Number of contributors in the last three months:** 23


### Project popularity

Score: **9.66**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 49
1.  **Number of stars for a GitHub repository:** 8519
