...
**Confidence**: High (9.26, max confidence value is 10.0)
...
1.  **[Project popularity](#project-popularity)**: **2.7** (weight is 0.5)
...
Score: **2.38**, confidence is 8.61 (low), weight is 1.0 (high)
...
Score: **2.0**, confidence is 9.3 (high), weight is 0.6 (medium)
...
373 commits in the last 3 months results to 10.00 points
26 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 373
1.  **Number of contributors in the last three months:** 26


### Project popularity

Score: **2.7**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2176
1.  **Number of watchers for a GitHub repository:** 156
...
Score: **0.0**, confidence is 4.15 (low), weight is 1.0 (high)
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, CPP, JAVA, PHP, RUBY, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
...
Score: **0.0**, confidence is 2.5 (low), weight is 0.3 (medium)
