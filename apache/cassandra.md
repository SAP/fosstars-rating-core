...
1.  **[Project popularity](#project-popularity)**: **9.32** (weight is 0.5)
...
225 commits in the last 3 months results to 10.00 points
17 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 225
1.  **Number of contributors in the last three months:** 17


### Project popularity

Score: **9.32**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 7816
...
1.  [CVE-2021-44521](https://nvd.nist.gov/vuln/detail/CVE-2021-44521)
