...
1.  **[Security testing](#security-testing)**: **3.57** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **4.98** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.92** (weight is 0.5)
...
1.  **Number of projects on GitHub that use an open source project:** 247
1.  **Number of stars for a GitHub repository:** 2402
1.  **Number of watchers for a GitHub repository:** 107
...
Score: **4.98**, confidence is 10.0 (max), weight is 1.0 (high)
