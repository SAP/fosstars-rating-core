...
1.  **[Security testing](#security-testing)**: **2.6** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **0.93** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **6.28** (weight is 0.5)
...
Score: **2.6**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **6.28**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 5019
1.  **Number of watchers for a GitHub repository:** 378
...
Score: **0.93**, confidence is 10.0 (max), weight is 1.0 (high)
