...
1.  **[Project activity](#project-activity)**: **9.85** (weight is 0.5)
...
Score: **9.85**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

61 commits in the last 3 months results to 9.38 points
2 contributors increase the score value from 9.38 to 9.85
...
1.  **Number of projects on GitHub that use an open source project:** 113
1.  **Number of stars for a GitHub repository:** 1354
