...
1.  **[Security testing](#security-testing)**: **1.07** (weight is 1.0)
...
Score: **1.07**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Number of stars for a GitHub repository:** 1814
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, OTHER
