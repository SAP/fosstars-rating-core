...
1.  **[Project popularity](#project-popularity)**: **1.34** (weight is 0.5)
...
Score: **0.0**, confidence is 9.3 (high), weight is 0.6 (medium)
...
Score: **1.34**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1106
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** CPP, JAVA, SCALA, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
