...
1.  **[Security testing](#security-testing)**: **2.82** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **1.84** (weight is 1.0)
        ...
        1.  **[How a project uses MyPy](#how-a-project-uses-mypy)**: **6.0** (weight is 0.2)
...
1.  **[Project popularity](#project-popularity)**: **7.34** (weight is 0.5)
...
Score: **2.82**, confidence is 10.0 (max), weight is 1.0 (high)
...
776 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 776
1.  **Number of contributors in the last three months:** 29


### Project popularity

Score: **7.34**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 6468
...
Score: **1.84**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, JAVA, SCALA, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
...
1.  **Does it use nohttp?** No
1.  **Package managers:** MAVEN, GRADLE, NPM, YARN, GOMODULES
