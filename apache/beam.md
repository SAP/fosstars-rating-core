...
**Score**: **5.25**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **5.85** (weight is 0.5)
...
679 commits in the last 3 months results to 10.00 points
66 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 679
1.  **Number of contributors in the last three months:** 66


### Project popularity

Score: **5.85**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 5005
