...
1.  **[Project popularity](#project-popularity)**: **5.86** (weight is 0.5)
...
6 contributors increase the score value from 3.85 to 4.62
...
Score: **5.86**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 5076
