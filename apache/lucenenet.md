...
1.  **[Security testing](#security-testing)**: **2.92** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **8.8** (weight is 0.5)
    
1.  **[Project popularity](#project-popularity)**: **2.24** (weight is 0.5)
...
Score: **2.92**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **8.8**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

52 commits in the last 3 months results to 8.00 points
3 contributors increase the score value from 8.00 to 8.80
...
Score: **2.24**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1656
