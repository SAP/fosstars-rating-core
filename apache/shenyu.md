...
1.  **[Project popularity](#project-popularity)**: **8.61** (weight is 0.5)
...
Score: **8.61**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 7621
1.  **Number of watchers for a GitHub repository:** 296
