...
**Score**: **6.7**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **6.22** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **3.68** (weight is 1.0)
...
Score: **6.22**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Info about vulnerabilities in the project:** 46 vulnerabilities, [details below](#known-vulnerabilities)
...
804 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 804
...
1.  **Number of projects on GitHub that use an open source project:** 5349
1.  **Number of stars for a GitHub repository:** 29159
1.  **Number of watchers for a GitHub repository:** 761
...
Score: **3.68**, confidence is 10.0 (max), weight is 1.0 (high)
