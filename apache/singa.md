...
1.  **[Project popularity](#project-popularity)**: **2.77** (weight is 0.5)
...
5 contributors increase the score value from 3.23 to 3.88
...
Score: **2.77**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2366
