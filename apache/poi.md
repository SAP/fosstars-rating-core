...
1.  **[Security testing](#security-testing)**: **3.24** (weight is 1.0)
...
Score: **3.24**, confidence is 10.0 (max), weight is 1.0 (high)
...
248 commits in the last 3 months results to 10.00 points
...
1.  **Number of projects on GitHub that use an open source project:** 183088
1.  **Number of stars for a GitHub repository:** 1258
