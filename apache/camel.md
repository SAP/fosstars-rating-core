...
1.  **[Project popularity](#project-popularity)**: **4.82** (weight is 0.5)
...
1.  **Info about vulnerabilities in the project:** 20 vulnerabilities, [details below](#known-vulnerabilities)
...
1209 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 1209
1.  **Number of contributors in the last three months:** 16


### Project popularity

Score: **4.82**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 3912
