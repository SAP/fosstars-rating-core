...
1.  **[Project popularity](#project-popularity)**: **5.62** (weight is 0.5)
...
1.  **Info about vulnerabilities in the project:** 22 vulnerabilities, [details below](#known-vulnerabilities)
...
1630 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 1630
1.  **Number of contributors in the last three months:** 17


### Project popularity

Score: **5.62**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 4726
1.  **Number of watchers for a GitHub repository:** 268
