...
**Score**: **5.04**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **2.51** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **0.53** (weight is 1.0)
...
Score: **2.51**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Info about vulnerabilities in the project:** 27 vulnerabilities, [details below](#known-vulnerabilities)
...
1120 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 1120
...
1.  **Number of stars for a GitHub repository:** 35010
1.  **Number of watchers for a GitHub repository:** 2063
