...
**Score**: **5.95**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **4.36** (weight is 0.5)
...
347 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 347
1.  **Number of contributors in the last three months:** 1


### Project popularity

Score: **4.36**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 3877
1.  **Number of watchers for a GitHub repository:** 145
