...
1.  **[Project popularity](#project-popularity)**: **4.05** (weight is 0.5)
...
2 contributors increase the score value from 3.54 to 3.72
...
Score: **4.05**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 3378
