...
1.  **[Project popularity](#project-popularity)**: **1.71** (weight is 0.5)
...
4 contributors increase the score value from 2.15 to 2.37
...
Score: **1.71**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 24
1.  **Number of stars for a GitHub repository:** 1468
1.  **Number of watchers for a GitHub repository:** 68
