...
1.  **Number of projects on GitHub that use an open source project:** 158
1.  **Number of stars for a GitHub repository:** 4379
1.  **Number of watchers for a GitHub repository:** 280
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, CPP, JAVA, C_SHARP, PHP, PYTHON, JAVASCRIPT, OTHER
