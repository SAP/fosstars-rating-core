...
1.  **[Security testing](#security-testing)**: **7.91** (weight is 1.0)
    1.  **[Dependency testing](#dependency-testing)**: **10.0** (weight is 1.0)
        ...
        1.  **[OWASP Dependency Check score](#owasp-dependency-check-score)**: **3.3** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.31** (weight is 0.5)
...
Score: **2.31**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1917
...
Score: **3.3**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **How is OWASP Dependency Check used?** Optional
1.  **Package managers:** MAVEN, NPM, YARN
1.  **What is the threshold for OWASP Dependency Check?** 9.0
