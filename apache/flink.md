...
1.  **[Security testing](#security-testing)**: **2.81** (weight is 1.0)
...
Score: **2.81**, confidence is 10.0 (max), weight is 1.0 (high)
...
1243 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 1243
...
1.  **Number of stars for a GitHub repository:** 17215
1.  **Number of watchers for a GitHub repository:** 935
