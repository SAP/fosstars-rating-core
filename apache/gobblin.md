...
**Score**: **3.67**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.67** (weight is 0.5)
...
Score: **2.67**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2112
