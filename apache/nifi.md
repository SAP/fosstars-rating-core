...
1.  **[Project popularity](#project-popularity)**: **3.4** (weight is 0.5)
...
1.  **Info about vulnerabilities in the project:** 28 vulnerabilities, [details below](#known-vulnerabilities)
...
Score: **3.4**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2791
