...
**Score**: **5.74**, max score value is 10.0
...
1.  **Info about vulnerabilities in the project:** 192 vulnerabilities, [details below](#known-vulnerabilities)
...
281 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 281
...
1.  **Number of projects on GitHub that use an open source project:** 21788
1.  **Number of stars for a GitHub repository:** 5622
1.  **Number of watchers for a GitHub repository:** 483
