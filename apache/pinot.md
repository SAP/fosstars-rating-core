...
1.  **[Project popularity](#project-popularity)**: **5.23** (weight is 0.5)
...
287 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 287
1.  **Number of contributors in the last three months:** 1


### Project popularity

Score: **5.23**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of watchers for a GitHub repository:** 244
