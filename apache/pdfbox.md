...
**Score**: **6.9**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **8.88** (weight is 0.5)
...
2 contributors increase the score value from 8.46 to 8.88
...
1.  **Number of stars for a GitHub repository:** 1889
