...
1.  **[Project popularity](#project-popularity)**: **3.48** (weight is 0.5)
...
7 contributors increase the score value from 9.85 to 11.82
...
Score: **3.48**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2767
