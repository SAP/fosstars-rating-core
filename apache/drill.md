...
1.  **[Project activity](#project-activity)**: **7.27** (weight is 0.5)
    
1.  **[Project popularity](#project-popularity)**: **2.29** (weight is 0.5)
...
Score: **7.27**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

45 commits in the last 3 months results to 6.92 points
2 contributors increase the score value from 6.92 to 7.27
...
Score: **2.29**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 1765
