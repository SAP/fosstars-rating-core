...
1.  **[Security testing](#security-testing)**: **3.21** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **3.61** (weight is 0.5)
...
Score: **3.21**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **3.61**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 2786
...
1.  **Is it included to OSS-Fuzz?** Yes
1.  **Programming languages:** C, PHP, PYTHON, JAVASCRIPT, OTHER
