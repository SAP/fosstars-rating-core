...
1.  **[Project popularity](#project-popularity)**: **4.37** (weight is 0.5)
...
7 contributors increase the score value from 4.00 to 4.80
...
Score: **4.37**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 3611
