...
**Score**: **7.66**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **6.06** (weight is 0.5)
...
Score: **6.06**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1925
1.  **Number of stars for a GitHub repository:** 4031
