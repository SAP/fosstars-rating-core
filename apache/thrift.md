...
1.  **Number of projects on GitHub that use an open source project:** 3021
1.  **Number of stars for a GitHub repository:** 9559
1.  **Number of watchers for a GitHub repository:** 462
...
1.  **Does it use nohttp?** No
1.  **Package managers:** MAVEN, GRADLE, NPM, YARN, RUBYGEMS, COMPOSER, GOMODULES
