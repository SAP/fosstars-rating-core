...
1.  **[Security testing](#security-testing)**: **2.57** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **0.78** (weight is 1.0)
...
392 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 392
...
1.  **Number of stars for a GitHub repository:** 9054
1.  **Number of watchers for a GitHub repository:** 391
...
Score: **0.78**, confidence is 10.0 (max), weight is 1.0 (high)
