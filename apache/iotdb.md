...
643 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 643
...
1.  **Number of stars for a GitHub repository:** 3060
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, CPP, JAVA, SCALA, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER
