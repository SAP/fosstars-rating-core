...
1.  **[Project popularity](#project-popularity)**: **5.55** (weight is 0.5)
...
196 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 196
1.  **Number of contributors in the last three months:** 3


### Project popularity

Score: **5.55**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 4774
1.  **Number of watchers for a GitHub repository:** 233
