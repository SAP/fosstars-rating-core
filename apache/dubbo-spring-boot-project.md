...
1.  **[Project popularity](#project-popularity)**: **6.53** (weight is 0.5)
...
Score: **6.53**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 5357
