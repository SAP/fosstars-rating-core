...
1.  **[Project popularity](#project-popularity)**: **6.64** (weight is 0.5)
...
Score: **6.64**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 396
