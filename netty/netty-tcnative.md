...
**Score**: **3.68**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **0.84** (weight is 0.5)
...
Score: **0.84**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 722
1.  **Number of stars for a GitHub repository:** 220
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, CPP, JAVA, RUBY, OTHER
