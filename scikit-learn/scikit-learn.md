...
1.  [Suggest a security policy for the project](https://github.com/scikit-learn/scikit-learn/security/policy)
...
1.  **Number of projects on GitHub that use an open source project:** 267068
1.  **Number of stars for a GitHub repository:** 47602
1.  **Number of watchers for a GitHub repository:** 2234
...
1.  [CVE-2020-13092](https://nvd.nist.gov/vuln/detail/CVE-2020-13092): ** DISPUTED ** scikit-learn (aka sklearn) through 0.23.0 can unserialize and execute commands from an untrusted file that is passed to the joblib.load() function, if __reduce__ makes an os.system call. NOTE: third parties dispute this issue because the joblib.load() function is documented as unsafe and it is the user's responsibility to use the function in a secure manner.
1.  [CVE-2020-28975](https://nvd.nist.gov/vuln/detail/CVE-2020-28975): ** DISPUTED ** svm_predict_values in svm.cpp in Libsvm v324, as used in scikit-learn 0.23.2 and other products, allows attackers to cause a denial of service (segmentation fault) via a crafted model SVM (introduced via pickle, json, or any other model permanence standard) with a large value in the _n_support array. NOTE: the scikit-learn vendor's position is that the behavior can only occur if the library's API is violated by an application that changes a private attribute.
