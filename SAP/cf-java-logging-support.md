...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/cf-java-logging-support)
...
1.  **Number of stars for a GitHub repository:** 55
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** JAVA, RUBY, PYTHON
