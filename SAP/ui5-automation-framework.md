# SAP/ui5-automation-framework

https://github.com/SAP/ui5-automation-framework

Last updated on Oct 13, 2021

**Rating**: **BAD**

**Score**: **2.99**, max score value is 10.0
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/ui5-automation-framework)
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, CPP, C_SHARP, JAVASCRIPT, TYPESCRIPT, OTHER
