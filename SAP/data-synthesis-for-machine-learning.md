...
The README does not seem to have a badge that points to REUSE status (https://api.reuse.software/info/github.com/SAP/data-synthesis-for-machine-learning)
...
The README does not contain required text that should match '# Requirements'
