...
https://github.com/SAP/ui5-builder
...
1.  **[Security testing](#security-testing)**: **5.68** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **5.72** (weight is 0.5)
    
1.  **[Project popularity](#project-popularity)**: **0.28** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/ui5-builder)
...
Score: **5.68**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **5.72**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

31 commits in the last 3 months results to 4.77 points
5 contributors increase the score value from 4.77 to 5.72
...
Score: **0.28**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 229
1.  **Number of stars for a GitHub repository:** 57
1.  **Number of watchers for a GitHub repository:** 22
