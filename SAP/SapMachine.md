...
1.  **[Project popularity](#project-popularity)**: **0.43** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/SapMachine)
...
963 commits in the last 3 months results to 10.00 points
127 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 963
1.  **Number of contributors in the last three months:** 127


### Project popularity

Score: **0.43**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 334
1.  **Number of watchers for a GitHub repository:** 28
