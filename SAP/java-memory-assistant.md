# SAP/java-memory-assistant

https://github.com/SAP/java-memory-assistant
...
1.  **[Security testing](#security-testing)**: **1.82** (weight is 1.0)
...
Score: **1.82**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  **Number of stars for a GitHub repository:** 20
