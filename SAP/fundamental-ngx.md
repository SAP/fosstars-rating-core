...
**Score**: **6.75**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **0.32** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/fundamental-ngx)
...
1.  **Number of projects on GitHub that use an open source project:** 44
1.  **Number of stars for a GitHub repository:** 178
1.  **Number of watchers for a GitHub repository:** 33
