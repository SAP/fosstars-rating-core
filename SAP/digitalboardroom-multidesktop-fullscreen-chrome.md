# SAP/digitalboardroom-multidesktop-fullscreen-chrome

https://github.com/SAP/digitalboardroom-multidesktop-fullscreen-chrome

Last updated on Oct 13, 2021

**Rating**: **BAD**

**Score**: **3.11**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **2.08** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **1.02** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/digitalboardroom-multidesktop-fullscreen-chrome)
...
Score: **2.08**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **1.02**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

6 commits in the last 3 months results to 0.92 points
3 contributors increase the score value from 0.92 to 1.02
...
Score: **0.06**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 23
