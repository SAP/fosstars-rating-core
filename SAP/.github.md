...
## Violated rules
1.  [**[rl-assigned_teams-4]**](#rl-assigned_teams-4) Does it have a team with push privileges on GitHub? **No**
...
1.  [**[rl-assigned_teams-2]**](#rl-assigned_teams-2) Does it have an admin team on GitHub? **No**
...
The project does not have a team with push privileges
...
The project does not have an admin team
...
The README does not seem to have a badge that points to REUSE status (https://api.reuse.software/info/github.com/SAP/.github)
