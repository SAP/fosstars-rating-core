...
https://github.com/SAP/cloud-primetime

Last updated on Oct 13, 2021

**Rating**: **BAD**

**Score**: **3.21**, max score value is 10.0

**Confidence**: High (9.51, max confidence value is 10.0)
...
1.  **[Project activity](#project-activity)**: **0.68** (weight is 0.5)
...
Score: **0.68**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

4 commits in the last 3 months results to 0.62 points
3 contributors increase the score value from 0.62 to 0.68
