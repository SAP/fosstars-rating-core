...
https://github.com/SAP/devops-docker-images

Last updated on Oct 13, 2021

**Rating**: **BAD**

**Score**: **3.26**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **0.12** (weight is 0.5)
...
Score: **0.12**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 59
1.  **Number of watchers for a GitHub repository:** 18
