...
1.  **[Project popularity](#project-popularity)**: **0.27** (weight is 0.5)
...
Score: **6.82**, confidence is 9.52 (high), weight is 1.0 (high)
...
218 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 218
1.  **Number of contributors in the last three months:** 2


### Project popularity

Score: **0.27**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 106
1.  **Number of stars for a GitHub repository:** 127
