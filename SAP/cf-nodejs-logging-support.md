...
1.  **[Project popularity](#project-popularity)**: **0.42** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/cf-nodejs-logging-support)
...
Score: **0.42**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 475
1.  **Number of stars for a GitHub repository:** 36
1.  **Number of watchers for a GitHub repository:** 19
