...
1.  **[Security testing](#security-testing)**: **5.45** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **3.92** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/openui5)
...
Score: **5.45**, confidence is 10.0 (max), weight is 1.0 (high)
...
2656 commits in the last 3 months results to 10.00 points
129 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 2656
1.  **Number of contributors in the last three months:** 129


### Project popularity

Score: **3.92**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 667
1.  **Number of stars for a GitHub repository:** 2479
1.  **Number of watchers for a GitHub repository:** 299
...
1.  [CVE-2019-0281](https://nvd.nist.gov/vuln/detail/CVE-2019-0281): SAPUI5 and OpenUI5, before versions 1.38.39, 1.44.39, 1.52.25, 1.60.6 and 1.63.0, does not sufficiently encode user-controlled inputs, resulting in Cross-Site Scripting (XSS) vulnerability.
