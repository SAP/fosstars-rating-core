...
1.  **[Project popularity](#project-popularity)**: **0.74** (weight is 0.5)
...
Score: **0.74**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 12
1.  **Number of stars for a GitHub repository:** 562
