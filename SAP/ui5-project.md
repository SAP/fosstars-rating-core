...
https://github.com/SAP/ui5-project
...
5 contributors increase the score value from 4.31 to 5.17
...
Score: **0.25**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 212
