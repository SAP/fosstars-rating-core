...
**Score**: **3.16**, max score value is 10.0
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/node-rfc)
...
1.  **Number of projects on GitHub that use an open source project:** 81
1.  **Number of stars for a GitHub repository:** 201
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** CPP, JAVASCRIPT, TYPESCRIPT, OTHER
