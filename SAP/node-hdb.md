...
1.  **[Project popularity](#project-popularity)**: **1.18** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/node-hdb)
...
1.  **Number of projects on GitHub that use an open source project:** 1080
1.  **Number of stars for a GitHub repository:** 301
1.  **Number of watchers for a GitHub repository:** 49
