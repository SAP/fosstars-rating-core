...
1.  [**[rl-assigned_teams-1]**](#rl-assigned_teams-1) Does it have enough teams on GitHub? **No**
...
The project should have at least 2 teams
...
The README does not seem to have a badge that points to REUSE status (https://api.reuse.software/info/github.com/SAP/cloud-sdk-ios)
