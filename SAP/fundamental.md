...
1.  **[Security testing](#security-testing)**: **7.27** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **0.35** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/fundamental)
...
Score: **7.27**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **0.35**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 246
1.  **Number of watchers for a GitHub repository:** 32
