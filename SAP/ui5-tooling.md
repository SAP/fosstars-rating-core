...
1.  **[Project popularity](#project-popularity)**: **0.56** (weight is 0.5)
...
Score: **0.56**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 375
1.  **Number of watchers for a GitHub repository:** 55
