...
https://github.com/SAP/gigya-react-native-plugin-for-sap-customer-data-cloud

Last updated on Oct 13, 2021

**Rating**: **BAD**

**Score**: **2.98**, max score value is 10.0
...
Score: **1.43**, confidence is 9.52 (high), weight is 1.0 (high)
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** C, JAVA, RUBY, JAVASCRIPT, TYPESCRIPT, OTHER
