...
1.  **[Project popularity](#project-popularity)**: **0.19** (weight is 0.5)
...
Score: **6.36**, confidence is 10.0 (max), weight is 1.0 (high)
...
90 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 90
1.  **Number of contributors in the last three months:** 3


### Project popularity

Score: **0.19**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 76
1.  **Number of stars for a GitHub repository:** 94
