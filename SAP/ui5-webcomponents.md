...
1.  **[Project popularity](#project-popularity)**: **1.15** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/ui5-webcomponents)
...
296 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 296
1.  **Number of contributors in the last three months:** 3


### Project popularity

Score: **1.15**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 998
1.  **Number of watchers for a GitHub repository:** 46
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** RUBY, JAVASCRIPT, OTHER
