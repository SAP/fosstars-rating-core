...
1.  **[Project popularity](#project-popularity)**: **0.7** (weight is 0.5)
...
Score: **0.7**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 575
...
1.  **Is it included to OSS-Fuzz?** No
1.  **Programming languages:** SCALA, PYTHON, GO, OTHER
