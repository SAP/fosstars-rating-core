...
**Score**: **3.1**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **0.54** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/SAP/PyRFC)
...
Score: **0.54**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 359
1.  **Number of watchers for a GitHub repository:** 48
