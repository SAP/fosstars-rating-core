...
**Score**: **5.14**, max score value is 10.0
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/huggingface/transformers)
...
1.  [Suggest a security policy for the project](https://github.com/huggingface/transformers/security/policy)
...
526 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 526
...
1.  **Number of projects on GitHub that use an open source project:** 16401
1.  **Number of stars for a GitHub repository:** 52669
1.  **Number of watchers for a GitHub repository:** 767
