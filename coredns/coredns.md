...
1.  **[Security reviews](#security-reviews)**: **0.25** (weight is 0.2)
...
Score: **6.82**, confidence is 9.6 (high), weight is 1.0 (high)
...
124 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 124
...
1.  **Number of projects on GitHub that use an open source project:** 715
1.  **Number of stars for a GitHub repository:** 9559
1.  **Number of watchers for a GitHub repository:** 231


### Security reviews

Score: **0.25**, confidence is 10.0 (max), weight is 0.2 (low)
...
Score: **5.0**, confidence is 8.33 (low), weight is 1.0 (high)
