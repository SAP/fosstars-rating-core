...
1.  **[Project activity](#project-activity)**: **6.6** (weight is 0.5)
    
1.  **[Project popularity](#project-popularity)**: **6.5** (weight is 0.5)
...
Score: **6.82**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **6.6**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

39 commits in the last 3 months results to 6.00 points
3 contributors increase the score value from 6.00 to 6.60
...
Score: **6.5**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1911
1.  **Number of stars for a GitHub repository:** 4964
1.  **Number of watchers for a GitHub repository:** 80
