...
**Score**: **3.0**, max score value is 10.0
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/benjaminp/six)
...
1.  [Suggest a security policy for the project](https://github.com/benjaminp/six/security/policy)
...
1.  **Number of projects on GitHub that use an open source project:** 982286
1.  **Number of stars for a GitHub repository:** 827
1.  **Number of watchers for a GitHub repository:** 23
