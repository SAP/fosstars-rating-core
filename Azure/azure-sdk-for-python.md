...
1.  **[Project popularity](#project-popularity)**: **4.3** (weight is 0.5)
...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/Azure/azure-sdk-for-python)
...
616 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:



1.  **Number of commits in the last three months:** 616
1.  **Number of contributors in the last three months:** 1


### Project popularity

Score: **4.3**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 1625
1.  **Number of stars for a GitHub repository:** 2198
1.  **Number of watchers for a GitHub repository:** 306
