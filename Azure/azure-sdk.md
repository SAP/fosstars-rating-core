...
**Score**: **4.12**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **0.9** (weight is 0.5)
...
259 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 259
1.  **Number of contributors in the last three months:** 2


### Project popularity

Score: **0.9**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 233
