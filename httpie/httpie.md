...
More info:
1.  [List of issues on LGTM](https://lgtm.com/projects/g/httpie/httpie)
...
1.  [Suggest a security policy for the project](https://github.com/httpie/httpie/security/policy)
...
1.  **Number of projects on GitHub that use an open source project:** 9215
1.  **Number of stars for a GitHub repository:** 52438
1.  **Number of watchers for a GitHub repository:** 1053
